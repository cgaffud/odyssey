...
public class InnateAspectHoeItem extends HoeItem implements InnateAspectItem {
    public final InnateAspectHolder innateAspectHolder;

    public InnateAspectHoeItem(Properties properties, Tier tier, float attackSpeed, float damage, List<AspectInstance> innateAspectList) {
