...
public class InnateAspectPickaxeItem extends OdysseyPickaxeItem implements InnateAspectItem {
    public final InnateAspectHolder innateAspectHolder;

    public InnateAspectPickaxeItem(Properties properties, Tier tier, MeleeWeaponClass meleeWeaponClass, float damage, List<AspectInstance> innateAspectList) {
