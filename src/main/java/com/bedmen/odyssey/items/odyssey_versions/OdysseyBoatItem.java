...
public class OdysseyBoatItem extends Item {
    ...
    private final OdysseyBoat.Type type;

    public OdysseyBoatItem(OdysseyBoat.Type p_40619_, Item.Properties p_40620_) {
        super(p_40620_);
        this.type = p_40619_;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                OdysseyBoat boat = new OdysseyBoat(p_40622_, hitresult.getLocation().x, hitresult.getLocation().y, hitresult.getLocation().z);
