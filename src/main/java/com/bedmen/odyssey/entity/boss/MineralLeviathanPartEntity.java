...
public class MineralLeviathanPartEntity extends MonsterEntity implements IRotationallyIncompetent {
...
//        this.goalSelector.addGoal(1, new MineralLeviathanEntity.LoopingGoal(this));
    ...
    static class IdleGoal extends Goal {
        private final MineralLeviathanPartEntity entity;
        private float dXRot;
        private float dYRot;

        public IdleGoal(MineralLeviathanPartEntity entity) {
            this.entity = entity;
        }
    ...
    static class ChargingGoal extends Goal {
        ...
        public ChargingGoal(MineralLeviathanPartEntity entity) {
            this.entity = entity;
    ...
    static class PassingGoal extends Goal {
        ...
        public PassingGoal(MineralLeviathanPartEntity entity) {
            this.entity = entity;
        }
    ...
    static class LoopingGoal extends Goal {
        ...
        public LoopingGoal(MineralLeviathanPartEntity entity) {
            this.entity = entity;
            this.target = entity.getTarget();
        }
