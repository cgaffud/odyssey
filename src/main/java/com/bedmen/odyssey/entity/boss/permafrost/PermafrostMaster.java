...
public class PermafrostMaster extends BossMaster {
    ...
    public int getMainId() {
        return this.entityData.get(DATA_MAIN_ID);
    }

    public void setMainId(int mainId) {
        this.entityData.set(DATA_MAIN_ID, mainId);
    }
    ...
    public void spawnSubEntities() {
        if (this.getConduit().isEmpty()) {
            ...
            if (permafrostConduit != null) {
                ...
                Odyssey.LOGGER.error("PermafrostConduit failed to spawn head in spawnSubEntities");
            }
        }
