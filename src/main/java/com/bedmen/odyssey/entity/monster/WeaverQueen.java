...
public class WeaverQueen extends Weaver {

    public WeaverQueen(EntityType<? extends Weaver> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 80.0D).add(Attributes.MOVEMENT_SPEED, 0.45d).add(Attributes.ATTACK_DAMAGE, 5d);
    }

    public boolean causeFallDamage(float fallDistance, float multiplier, DamageSource damageSource) {
        return super.causeFallDamage(fallDistance, multiplier*0.4f, damageSource);
    }
