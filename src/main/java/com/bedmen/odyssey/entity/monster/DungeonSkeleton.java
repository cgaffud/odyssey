...
public class DungeonSkeleton extends OdysseySkeleton implements DungeonMonster {
    protected BlockPos dungeonPos = null;

    public DungeonSkeleton(EntityType<? extends OdysseySkeleton> entityType, Level level, BlockPos dungeonPos) {
        super(entityType, level);
        this.dungeonPos = dungeonPos;
    }

    public DungeonSkeleton(EntityType<? extends OdysseySkeleton> entityType, Level level) {
        super(entityType, level);
    }
