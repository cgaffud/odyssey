...
public class OldPermafrostIcicleEntity extends DamagingProjectileEntity {
    ...
    public OldPermafrostIcicleEntity(EntityType<? extends OldPermafrostIcicleEntity> p_i50147_1_, World p_i50147_2_) {
    ...
    public OldPermafrostIcicleEntity(World p_i1794_1_, LivingEntity p_i1794_2_, double x, double y, double z, float damage, int timer, LivingEntity target) {
    ...
    @OnlyIn(Dist.CLIENT)
    public OldPermafrostIcicleEntity(World p_i1795_1_, double p_i1795_2_, double p_i1795_4_, double p_i1795_6_, double p_i1795_8_, double p_i1795_10_, double p_i1795_12_) {
