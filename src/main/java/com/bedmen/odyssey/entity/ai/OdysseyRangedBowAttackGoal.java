...
public class OdysseyRangedBowAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
    private final T mob;
    ...
    public boolean canUse() {
        return this.mob.getTarget() != null && this.isHoldingBown();
    }

    protected boolean isHoldingBown() {
        return this.mob.isHolding(item -> item instanceof OdysseyBowItem);
    }
    ...
    public boolean canContinueToUse() {
        return (this.canUse() || !this.mob.getNavigation().isDone()) && this.isHoldingBown();
    }
            ...
            if (this.mob.isUsingItem()) {
                ...
                if (!flag && this.seeTime < -60) {
                    ...
                    if (i >= this.attackIntervalMin) {
                        this.mob.stopUsingItem();
                        this.mob.performRangedAttack(livingentity, ((OdysseyBowItem)itemStack.getItem()).getArrowVelocity(i, itemStack, EnchantmentUtil.getSuperChargeMultiplier(itemStack), null));
