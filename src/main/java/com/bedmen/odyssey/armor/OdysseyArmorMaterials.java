...
public enum OdysseyArmorMaterials implements ArmorMaterial {
    CACTUS("oddc:cactus", 5, new int[]{2,3,3,2}, 0, SoundEvents.WOOL_BREAK, 0.0f, () -> Ingredient.of(Items.CACTUS)),
    LEATHER("leather", 5, new int[]{2,3,4,2}, 0, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0f, () -> Ingredient.of(Items.LEATHER)),
    COCONUT("oddc:coconut", 0, new int[]{0,0,0,3}, 0, SoundEvents.WOOD_BREAK, 0.0f, () -> Ingredient.of(ItemRegistry.HOLLOW_COCONUT.get())),
    CHICKEN("oddc:chicken", 8, new int[]{3,5,6,4}, 0, SoundEvents.CHICKEN_HURT, 0.0f, () -> Ingredient.of(ItemRegistry.FEATHER_BUNDLE.get()), new SetBonusEnchSup(EnchantmentRegistry.SLOW_FALLING, "key.jump")),
    FUR("oddc:fur", 8, new int[]{3,5,6,4}, 0, SoundEvents.WOOL_FALL, 0.0f, () -> Ingredient.of(ItemRegistry.POLAR_BEAR_FUR.get())),
    CHAIN("chainmail", 15, new int[]{3,5,6, 4}, 0, SoundEvents.ARMOR_EQUIP_CHAIN,  0.0F, () -> Ingredient.of(Items.IRON_INGOT)),
    IRON("iron", 15, new int[]{3,6,7,4}, 0, SoundEvents.ARMOR_EQUIP_IRON,  0.0F, () -> Ingredient.of(Items.IRON_INGOT)),
    TURTLE("oddc:turtle", 25, new int[]{4,7,8,5}, 0, SoundEvents.ARMOR_EQUIP_TURTLE,  0.0F, () -> Ingredient.of(Items.SCUTE), new SetBonusEnchSup(EnchantmentRegistry.TURTLING, "key.sneak")),
    ...
    REINFORCED("oddc:reinforced", 25, new int[]{6,10,11,7}, 0, SoundEvents.ARMOR_EQUIP_IRON, 0.1F, () -> Ingredient.of(Items.IRON_INGOT)),
    DIAMOND("diamond", 33, new int[]{7,12,13,8}, 0, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.0F, () -> Ingredient.of(Items.DIAMOND)),
    ARCTIC("oddc:arctic", 20, new int[]{7,12,13,8}, 0, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.0F, () -> Ingredient.of(ItemRegistry.PERMAFROST_SHARD.get()), new SetBonusEnchSup(EnchantmentRegistry.FROST_WALKER, "passive")),
//    MARINE("oddc:marine", 25, new int[]{7,13,14,8}, 0, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.0F, () -> Ingredient.of(ItemRegistry.PEARL.get())),
    NETHERITE("netherite", 37, new int[]{7,13,15,9}, 5, SoundEvents.ARMOR_EQUIP_NETHERITE, 0.1F, () -> Ingredient.of(Items.NETHERITE_INGOT));
//    ZEPHYR("oddc:zephyr", 15, new int[]{5,9,10,6}, 0, SoundEvents.ARMOR_EQUIP_ELYTRA, 0.0F, () -> Ingredient.of(Items.PHANTOM_MEMBRANE); }, new SetBonusEnchSup(EnchantmentRegistry.GLIDING, "key.jump")),
