...
public enum OdysseyArmorMaterials implements ArmorMaterial {
    ...
    FUR("oddc:fur", 10, new int[]{3,5,5,3}, 0, SoundEvents.WOOL_FALL, 0.0f, () -> Ingredient.of(ItemRegistry.POLAR_BEAR_FUR.get())),
    GLIDER("oddc:glider", 10, new int[]{3,5,5,3}, 0, SoundEvents.ARMOR_EQUIP_ELYTRA, 0.0f, () -> Ingredient.of(Items.PHANTOM_MEMBRANE), new SetBonusEnchSup(EnchantmentRegistry.GLIDING, 1, "key.jump")),
