...
public enum OdysseyArmorMaterial implements IArmorMaterial {
    ...
    COCONUT("oddc:coconut", 0, new int[]{0,0,0,3}, 15, SoundEvents.WOOD_BREAK, 0.0f, () -> { return Ingredient.EMPTY;}),
    CHICKEN("oddc:chicken", 4, new int[]{2,3,3,2}, 15, SoundEvents.CHICKEN_HURT, 0.0f, () -> { return Ingredient.of(ItemRegistry.FEATHER_BUNDLE.get());}, new SetBonusEnchSup(EnchantmentRegistry.SLOW_FALLING, "key.jump")),
    ...
    TURTLE("oddc:turtle", 25, new int[]{4,7,8,5}, 9, SoundEvents.ARMOR_EQUIP_TURTLE,  0.0F, () -> { return Ingredient.of(Items.SCUTE); }, new SetBonusEnchSup(EnchantmentRegistry.TURTLING, "key.sneak")),
    ...
    OdysseyArmorMaterial(String name, int maxDamageFactor, int[] damageReductionArray, int enchantability, SoundEvent soundEvent, float knockbackResistance, Supplier<Ingredient> repairMaterial, SetBonusEnchSup... setBonusEnchSups){
        this.name = name;
