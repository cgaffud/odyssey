...
public class ModAxeItem extends ToolItem {
    ...
    public ModAxeItem(IItemTier tier, float attackDamageIn, float attackSpeedIn, Item.Properties builder) {
        super(attackDamageIn-1.0f, attackSpeedIn-4.0f, tier, EFFECTIVE_ON_BLOCKS, builder.addToolType(net.minecraftforge.common.ToolType.AXE, tier.getHarvestLevel()));
    }
