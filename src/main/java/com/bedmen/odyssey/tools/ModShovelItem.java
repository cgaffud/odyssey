...
public class ModShovelItem extends ToolItem {
    ...
    public ModShovelItem(IItemTier tier, float attackDamageIn, float attackSpeedIn, Item.Properties builder) {
        super(attackDamageIn-1.0f, attackSpeedIn-4.0f, tier, EFFECTIVE_ON, builder.addToolType(net.minecraftforge.common.ToolType.SHOVEL, tier.getHarvestLevel()));
    }
