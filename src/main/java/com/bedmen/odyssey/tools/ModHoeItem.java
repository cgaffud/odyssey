...
public class ModHoeItem extends ToolItem {
    ...
    public ModHoeItem(IItemTier itemTier, float attackDamage, float attackSpeed, Item.Properties properties) {
        super(attackDamage-1.0f, attackSpeed-4.0f, itemTier, EFFECTIVE_ON_BLOCKS, properties.addToolType(net.minecraftforge.common.ToolType.HOE, itemTier.getHarvestLevel()));
    }
