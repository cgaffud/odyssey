...
public class AlloyFurnaceResultSlot extends Slot {
    ...
    public AlloyFurnaceResultSlot(Player p_39542_, Container p_39543_, int p_39544_, int p_39545_, int p_39546_) {
    ...
    protected void checkTakeAchievements(ItemStack p_39558_) {
        ...
        this.removeCount = 0;
        net.minecraftforge.fmllegacy.hooks.BasicEventHooks.firePlayerSmeltedEvent(this.player, p_39558_);
    }
}
