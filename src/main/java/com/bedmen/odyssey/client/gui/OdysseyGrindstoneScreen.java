...
@OnlyIn(Dist.CLIENT)
public class OdysseyGrindstoneScreen extends ContainerScreen<OdysseyGrindstoneContainer> {
    private static final ResourceLocation GRINDSTONE_LOCATION = new ResourceLocation("textures/gui/container/grindstone.png");

    public OdysseyGrindstoneScreen(OdysseyGrindstoneContainer p_i51086_1_, PlayerInventory p_i51086_2_, ITextComponent p_i51086_3_) {
