...
import com.bedmen.odyssey.network.packet.RenameItemPacket;
...
@OnlyIn(Dist.CLIENT)
public class OdysseyAnvilScreen extends AbstractRepairScreen<OdysseyRepairContainer> {
    ...
    public OdysseyAnvilScreen(OdysseyRepairContainer p_i51103_1_, PlayerInventory p_i51103_2_, ITextComponent p_i51103_3_) {
    ...
    private void onNameChanged(String p_214075_1_) {
        if (!p_214075_1_.isEmpty()) {
            ...
            OdysseyNetwork.CHANNEL.sendToServer(new RenameItemPacket(s));
        }
    }
