...
@OnlyIn(Dist.CLIENT)
public class OdysseyCreativeScreen extends DisplayEffectsScreen<OdysseyCreativeScreen.CreativeContainer> {
    ...
    public OdysseyCreativeScreen(PlayerEntity p_i1088_1_) {
        super(new OdysseyCreativeScreen.CreativeContainer(p_i1088_1_), p_i1088_1_.inventory, StringTextComponent.EMPTY);
        ...
        if (p_184098_1_ == null && selectedTab != ItemGroup.TAB_INVENTORY.getId() && p_184098_4_ != ClickType.QUICK_CRAFT) {
            ...
            if (p_184098_1_ == this.destroyItemSlot && flag) {
                ...
                if (p_184098_1_ == this.destroyItemSlot) {
                    ...
                    this.minecraft.gameMode.handleCreativeModeItemAdd(itemstack1, ((OdysseyCreativeScreen.CreativeSlot)p_184098_1_).target.index);
                    ...
                    this.minecraft.player.inventoryMenu.clicked(p_184098_1_ == null ? p_184098_2_ : ((OdysseyCreativeScreen.CreativeSlot)p_184098_1_).target.index, p_184098_3_, p_184098_4_, this.minecraft.player);
    ...
    private void selectTab(ItemGroup p_147050_1_) {
        ...
        if (p_147050_1_ == ItemGroup.TAB_INVENTORY) {
            ...
            for(int l = 0; l < container.slots.size(); ++l) {
                ...
                Slot slot = new OdysseyCreativeScreen.CreativeSlot(container.slots.get(l), l, i1, j1);
    ...
    public static class CreativeContainer extends Container {
        ...
        public CreativeContainer(PlayerEntity p_i1086_1_) {
            ...
            for(int i = 0; i < 5; ++i) {
                for(int j = 0; j < 9; ++j) {
                    this.addSlot(new OdysseyCreativeScreen.LockedSlot(OdysseyCreativeScreen.CONTAINER, i * 9 + j, 9 + j * 18, 18 + i * 18));
                }
            }
            ...
            for(int k = 0; k < 5; ++k) {
                for(int l = 0; l < 9; ++l) {
                    ...
                    if (i1 >= 0 && i1 < this.items.size()) {
                        OdysseyCreativeScreen.CONTAINER.setItem(l + k * 9, this.items.get(i1));
                    } else {
                        OdysseyCreativeScreen.CONTAINER.setItem(l + k * 9, ItemStack.EMPTY);
                    }
                }
            }
        ...
        public boolean canTakeItemForPickAll(ItemStack p_94530_1_, Slot p_94530_2_) {
            return p_94530_2_.container != OdysseyCreativeScreen.CONTAINER;
        }

        public boolean canDragTo(Slot p_94531_1_) {
            return p_94531_1_.container != OdysseyCreativeScreen.CONTAINER;
        }
    }
