...
@OnlyIn(Dist.CLIENT)
public class OdysseyEditSignScreen extends Screen {
    private final OdysseySignTileEntityRenderer.SignModel signModel = new OdysseySignTileEntityRenderer.SignModel();
    private final OdysseySignTileEntity sign;
    private int frame;
    private int line;
    private TextInputUtil signField;
    private final String[] messages;

    public OdysseyEditSignScreen(OdysseySignTileEntity p_i1097_1_) {
        super(new TranslationTextComponent("sign.edit"));
        this.messages = IntStream.range(0, 4).mapToObj(p_i1097_1_::getMessage).map(ITextComponent::getString).toArray((p_243354_0_) -> {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        RenderMaterial rendermaterial = OdysseySignTileEntityRenderer.getMaterial(blockstate.getBlock());
