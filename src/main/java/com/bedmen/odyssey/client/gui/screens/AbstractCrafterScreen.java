...
public class AbstractCrafterScreen extends AbstractContainerScreen<AbstractCrafterMenu> {
    ...
    public AbstractCrafterScreen(AbstractCrafterMenu abstractCrafterMenu, Inventory inventory, Component title) {
        super(abstractCrafterMenu, inventory, title);
    }
