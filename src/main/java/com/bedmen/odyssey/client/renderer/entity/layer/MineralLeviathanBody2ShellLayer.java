...
public class MineralLeviathanBody2ShellLayer extends RenderLayer<MineralLeviathanBody2, MineralLeviathanBody2Model> {
    public static final ResourceLocation[][] SHELL_LOCATION = new ResourceLocation[9][11];
    private final EntityModel<MineralLeviathanBody2> model;
    ...
    public MineralLeviathanBody2ShellLayer(RenderLayerParent<MineralLeviathanBody2, MineralLeviathanBody2Model> renderLayerParent, EntityModelSet entityModelSet) {
        super(renderLayerParent);
        this.model = new MineralLeviathanBody2Model(entityModelSet.bakeLayer(MineralLeviathanBody2Model.LAYER_LOCATION));
    }

    public void render(PoseStack matrixStack, MultiBufferSource p_225628_2_, int p_225628_3_, MineralLeviathanBody2 entity, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        if (entity.hasShell()) {
    ...
    public ResourceLocation getTextureLocation(ResourceLocation[] locations, MineralLeviathanBody2 entity) {
