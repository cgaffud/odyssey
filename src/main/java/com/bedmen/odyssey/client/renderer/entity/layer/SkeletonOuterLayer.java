...
public class SkeletonOuterLayer<T extends Mob & RangedAttackMob, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    private static final ResourceLocation OVERGROWN_OUTER_LAYER= new ResourceLocation(Odyssey.MOD_ID,"textures/entity/skeleton/overgrown_outer_layer.png");
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int p_117555_, T mob, float p_117557_, float p_117558_, float p_117559_, float p_117560_, float p_117561_, float p_117562_) {
        ...
        if (mob instanceof OvergrownSkeleton overgrownSkeleton)
            coloredCutoutModelCopyLayerRender(this.getParentModel(), this.layerModel, OVERGROWN_OUTER_LAYER, poseStack, multiBufferSource, p_117555_, mob, p_117557_, p_117558_, p_117560_, p_117561_, p_117562_, p_117559_, 1.0F, 1.0F, 1.0F);
