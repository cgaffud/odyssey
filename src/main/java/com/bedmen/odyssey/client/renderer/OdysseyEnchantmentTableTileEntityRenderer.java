...
@OnlyIn(Dist.CLIENT)
public class OdysseyEnchantmentTableTileEntityRenderer extends TileEntityRenderer<OdysseyEnchantingTableTileEntity> {
    /** The texture for the book above the enchantment table. */
    public static final RenderMaterial TEXTURE_BOOK = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS, new ResourceLocation("entity/enchanting_table_book"));
    private final BookModel modelBook = new BookModel();

    public OdysseyEnchantmentTableTileEntityRenderer(TileEntityRendererDispatcher p_i226010_1_) {
        super(p_i226010_1_);
    }

    public void render(OdysseyEnchantingTableTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
