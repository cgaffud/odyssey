...
public class MineralLeviathanBodyModel extends SegmentedModel<MineralLeviathanBodyEntity> {
    private final ImmutableList<ModelRenderer> modelRendererImmutableList;
    private final ModelRenderer innerSegment;

    public MineralLeviathanBodyModel() {
        this.texWidth = 128;
        this.texHeight = 64;
    ...
    public void setupAnim(MineralLeviathanBodyEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
