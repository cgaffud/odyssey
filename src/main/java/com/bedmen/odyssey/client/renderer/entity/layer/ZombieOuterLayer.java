...
public class ZombieOuterLayer<T extends Zombie> extends RenderLayer<T, ZombieModel<T>> {
    ...
    private static final ResourceLocation OVERGROWN_OUTER_LAYER_LOCATION = new ResourceLocation(Odyssey.MOD_ID,"textures/entity/zombie/overgrown_outer_layer.png");
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int p_116926_, T mob, float p_116928_, float p_116929_, float p_116930_, float p_116931_, float p_116932_, float p_116933_) {
        ...
        if (mob instanceof OvergrownZombie overgrownZombie)
            coloredCutoutModelCopyLayerRender(this.getParentModel(), this.model, OVERGROWN_OUTER_LAYER_LOCATION, poseStack, multiBufferSource, p_116926_, mob, p_116928_, p_116929_, p_116931_, p_116932_, p_116933_, p_116930_, 1.0F, 1.0F, 1.0F);
    }
}