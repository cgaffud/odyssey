...
@OnlyIn(Dist.CLIENT)
public class NewEnchantmentTableTileEntityRenderer extends TileEntityRenderer<NewEnchantingTableTileEntity> {
    ...
    public NewEnchantmentTableTileEntityRenderer(TileEntityRendererDispatcher p_i226010_1_) {
        super(p_i226010_1_);
    }

    public void render(NewEnchantingTableTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
