...
@OnlyIn(Dist.CLIENT)
public class OdysseyHeldItemLayer<T extends LivingEntity, M extends EntityModel<T> & IHasArm> extends LayerRenderer<T, M> {
    public OdysseyHeldItemLayer(IEntityRenderer<T, M> p_i50934_1_) {
        super(p_i50934_1_);
    }
    ...
    public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        ...
        if(!flag && itemstack1.getItem() instanceof QuiverItem){
        ...
        if (!itemstack.isEmpty() || !itemstack1.isEmpty()) {
            ...
            if(flag || !(itemstack.getItem() instanceof QuiverItem)){
