...
public class ArctihornRenderer extends MobRenderer<ArctihornEntity, ArctihornModel<ArctihornEntity>> {
     ...
     */
    public ResourceLocation getEntityTexture(ArctihornEntity entity) {
        return ARCTIHORN_TEXTURES;
    }

    protected void applyRotations(ArctihornEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
     ...
     */
    protected float handleRotationFloat(ArctihornEntity livingBase, float partialTicks) {
