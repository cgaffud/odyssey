...
@OnlyIn(Dist.CLIENT)
public class OdysseySignTileEntityRenderer extends TileEntityRenderer<OdysseySignTileEntity> {
    private final OdysseySignTileEntityRenderer.SignModel signModel = new OdysseySignTileEntityRenderer.SignModel();

    public OdysseySignTileEntityRenderer(TileEntityRendererDispatcher p_i226014_1_) {
        super(p_i226014_1_);
    }

    public void render(OdysseySignTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
