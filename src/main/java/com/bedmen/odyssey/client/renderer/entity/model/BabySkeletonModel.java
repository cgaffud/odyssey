...
@OnlyIn(Dist.CLIENT)
public class BabySkeletonModel<T extends BabySkeletonEntity> extends BipedModel<T> {
    public BabySkeletonModel() {
        this(0.0F, false);
    }

    public BabySkeletonModel(float p_i46303_1_, boolean p_i46303_2_) {
        super(p_i46303_1_);
        if (!p_i46303_2_) {
