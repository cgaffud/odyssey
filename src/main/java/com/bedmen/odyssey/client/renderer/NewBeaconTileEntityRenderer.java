...
@OnlyIn(Dist.CLIENT)
public class NewBeaconTileEntityRenderer extends TileEntityRenderer<NewBeaconTileEntity> {
    public static final ResourceLocation TEXTURE_BEACON_BEAM = new ResourceLocation("textures/entity/beacon_beam.png");

    public NewBeaconTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
    ...
    public void render(NewBeaconTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        for(int k = 0; k < list.size(); ++k) {
            NewBeaconTileEntity.BeamSegment beacontileentity$beamsegment = list.get(k);
