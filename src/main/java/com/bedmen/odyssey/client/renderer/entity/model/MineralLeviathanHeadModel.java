...
public class MineralLeviathanHeadModel extends SegmentedModel<MineralLeviathanHeadEntity> {
    ...
    public MineralLeviathanHeadModel() {
        ...
        s_mouth.texOffs(0, 4).addBox(-15.0F, -4.0F, -1.0F, 30.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 8).addBox(-14.0F, -6.0F, -1.0F, 28.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 12).addBox(-13.0F, -8.0F, -1.0F, 26.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 16).addBox(-12.0F, -10.0F, -1.0F, 24.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 20).addBox(-11.0F, -12.0F, -1.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 24).addBox(-10.0F, -14.0F, -1.0F, 20.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 28).addBox(-9.0F, -16.0F, -1.0F, 18.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 32).addBox(-8.0F, -18.0F, -2.0F, 16.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 36).addBox(-6.0F, -20.0F, -3.0F, 12.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 40).addBox(-4.0F, -22.0F, -4.0F, 8.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 44).addBox(-2.0F, -24.0F, -5.0F, 4.0F, 2.0F, 2.0F, 0.0F, false);
        s_mouth.texOffs(0, 48).addBox(-1.0F, -26.0F, -6.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        n_mouth.texOffs(0, 4).addBox(-15.0F, -4.0F, -1.0F, 30.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 8).addBox(-14.0F, -6.0F, -1.0F, 28.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 12).addBox(-13.0F, -8.0F, -1.0F, 26.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 16).addBox(-12.0F, -10.0F, -1.0F, 24.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 20).addBox(-11.0F, -12.0F, -1.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 24).addBox(-10.0F, -14.0F, -1.0F, 20.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 28).addBox(-9.0F, -16.0F, -1.0F, 18.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 32).addBox(-8.0F, -18.0F, 0.0F, 16.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 36).addBox(-6.0F, -20.0F, 1.0F, 12.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 40).addBox(-4.0F, -22.0F, 2.0F, 8.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 44).addBox(-2.0F, -24.0F, 3.0F, 4.0F, 2.0F, 2.0F, 0.0F, false);
        n_mouth.texOffs(0, 48).addBox(-1.0F, -26.0F, 4.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
