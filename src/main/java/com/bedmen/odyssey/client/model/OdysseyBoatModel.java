...
public class OdysseyBoatModel extends ListModel<OdysseyBoat> {
    public static final Map<OdysseyBoat.Type, ModelLayerLocation> LAYER_LOCATION = Stream.of(OdysseyBoat.Type.values()).collect(ImmutableMap.toImmutableMap((odysseyBoatType) -> {
        ...
        return new ModelLayerLocation(new ResourceLocation(Odyssey.MOD_ID, "boat/"+odysseyBoatType.getName()), "main");
    }));
    ...
    public OdysseyBoatModel(ModelPart p_170462_) {
    ...
    public void setupAnim(OdysseyBoat p_102269_, float p_102270_, float p_102271_, float p_102272_, float p_102273_, float p_102274_) {
    ...
    private static void animatePaddle(OdysseyBoat p_170465_, int p_170466_, ModelPart p_170467_, float p_170468_) {
