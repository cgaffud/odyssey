...
public class WraithlingModel<T extends Wraithling> extends AgeableListModel<T> implements ArmedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition torso = partdefinition.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-4.9F, -4.0F, -2.0F, 6.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.9F, 12.0F, 0.0F));
