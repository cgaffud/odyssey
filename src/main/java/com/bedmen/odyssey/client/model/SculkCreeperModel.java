package com.bedmen.odyssey.client.model;// Made with Blockbench 4.8.3
...
public class SculkCreeperModel<T extends SculkCreeper> extends OdysseyCreeperModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Odyssey.MOD_ID, "sculk_creeper"), "main");

	public SculkCreeperModel(ModelPart root) {super(root);}
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(40, 22).addBox(-12.5F, -14.0F, 0.0F, 9.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(40, 22).addBox(-12.5F, -14.0F, 0.0F, 9.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition grass = head.addOrReplaceChild("grass", CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
