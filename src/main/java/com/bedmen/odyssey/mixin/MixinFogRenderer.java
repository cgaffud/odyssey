...
public abstract class MixinFogRenderer {
    ...
    @Overwrite
    public static void setupFog(ActiveRenderInfo activeRenderInfoIn, net.minecraft.client.renderer.FogRenderer.FogType fogTypeIn, float farPlaneDistance, boolean nearFog) {
        setupFog(activeRenderInfoIn, fogTypeIn, farPlaneDistance, nearFog, 0);
    }

    @Overwrite
    public static void setupFog(ActiveRenderInfo activeRenderInfoIn, net.minecraft.client.renderer.FogRenderer.FogType fogTypeIn, float farPlaneDistance, boolean nearFog, float partialTicks) {
        FluidState fluidstate = activeRenderInfoIn.getFluidState();
        ...
        if (fluidstate.isTagged(FluidTags.WATER)) {
            ...
            } else if (fogTypeIn == net.minecraft.client.renderer.FogRenderer.FogType.FOG_SKY) {
                f2 = 0.0F;
                f3 = farPlaneDistance;
            } else {
