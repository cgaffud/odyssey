...
public class NewSmithingTableContainer extends Container {
    ...
    protected final IInventory inv = new Inventory(10) {
        ...
        public void setChanged() {
            super.setChanged();
            NewSmithingTableContainer.this.slotsChanged(this);
        }
    };
    ...
    public NewSmithingTableContainer(int id, PlayerInventory playerInv, IWorldPosCallable worldPos) {
        ...
        Slot slot0 = this.addSlot(new Slot(this.inv, 0, 20, 35) {
            public boolean mayPlace(ItemStack stack) {
                List<NewSmithingRecipe> list = con.world.getRecipeManager().getAllRecipesFor(ModRecipeType.NEW_SMITHING);
        ...
        this.addSlot(new Slot(this.resultInv, 10, 139, 35) {
            ...
            public boolean mayPickup(PlayerEntity playerIn) {
                return NewSmithingTableContainer.this.mayPickup(playerIn, this.hasItem());
            }

            public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
                return NewSmithingTableContainer.this.onTake(thePlayer, stack);
            }
        });
    ...
    public void updateRepairOutput() {
        List<NewSmithingRecipe> list = this.world.getRecipeManager().getRecipesFor(this.recipeType, this.inv, this.world);
        if (list.isEmpty()) {
