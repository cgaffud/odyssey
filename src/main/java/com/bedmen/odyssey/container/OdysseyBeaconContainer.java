...
public class OdysseyBeaconContainer extends Container {
    ...
    private final OdysseyBeaconContainer.BeaconSlot beaconSlot;
    private final IWorldPosCallable worldPosCallable;
    private final IIntArray beaconInfo;
    private boolean completionError1;
    private boolean completionError2;

    public OdysseyBeaconContainer(int id, IInventory p_i50099_2_) {
        this(id, p_i50099_2_, new IntArray(11), IWorldPosCallable.NULL);
    }

    public OdysseyBeaconContainer(int id, IInventory inventory, IIntArray beaconInfo, IWorldPosCallable worldPosCallable) {
        super(ContainerRegistry.BEACON.get(), id);
        checkContainerDataCount(beaconInfo, 11);
        this.beaconInfo = beaconInfo;
        this.worldPosCallable = worldPosCallable;
        this.beaconSlot = new OdysseyBeaconContainer.BeaconSlot(this, this.tileBeacon, 0, 116, 54);
    ...
    class BeaconSlot extends Slot {
        private OdysseyBeaconContainer beacon;

        public BeaconSlot(OdysseyBeaconContainer beacon, IInventory inventoryIn, int index, int xIn, int yIn) {
