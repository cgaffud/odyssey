...
public class AlloyFurnaceFuelSlot extends Slot {
    private final AlloyFurnaceContainer menu;

    public AlloyFurnaceFuelSlot(AlloyFurnaceContainer p_i50084_1_, IInventory p_i50084_2_, int p_i50084_3_, int p_i50084_4_, int p_i50084_5_) {
