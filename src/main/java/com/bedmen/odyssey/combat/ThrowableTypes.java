...
public class ThrowableTypes {
    ...
    public static final BoomerangType BONE_BOOMERANG = new BoomerangType("bone_boomerang", 5.0d, 1.1f, ThrowableType.SoundProfile.WOODEN, List.of(), List.of(new AspectInstance(Aspects.LOYALTY, 1.1f)), 0);
    public static final BoomerangType COPPER_DISC = new BoomerangType("copper_disc", 5.0d, 1.1f, ThrowableType.SoundProfile.METAL, List.of(), List.of(new AspectInstance(Aspects.PROJECTILE_KNOCKBACK, 0.5f)), 0);
