...
public class ThrowableTypes {
    ...
    public static final BoomerangType FLINT_DISC = new BoomerangType("flint_disc", 5.0d, 1.0f, ThrowableType.SoundProfile.WOODEN, List.of(), List.of(new AspectInstance(Aspects.PIERCING, 1.0f)), 0);
