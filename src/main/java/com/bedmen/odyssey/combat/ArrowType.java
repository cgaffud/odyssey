...
public enum ArrowType{
    ...
    FROST("frost", ItemRegistry.FROST_ARROW::get, OdysseyTiers.ARCTIC, 6.5d, List.of(new AspectInstance<>(Aspects.SNOW_STORM))),
    ETHEREAL("ethereal", ItemRegistry.ETHEREAL_ARROW::get, OdysseyTiers.AMETHYST, 6.0d, List.of());
    ...
    ArrowType(Lazy<Item> lazyItem, OdysseyTier odysseyTier, double damage, ResourceLocation resourceLocation){
        ...
        this.damage = damage;
        this.innateAspectHolder = new AspectHolder(List.of());
    ...
    ArrowType(String id, Lazy<Item> lazyItem, OdysseyTier odysseyTier, double damage, List<AspectInstance<?>> innateAspectList){
        ...
        this.tier = odysseyTier;
        this.damage = damage;
        this.innateAspectHolder = new AspectHolder(innateAspectList);
