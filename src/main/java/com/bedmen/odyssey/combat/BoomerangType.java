...
public enum BoomerangType implements ThrowableType {
    ...
    HEAVY_BONE(5.0d, 1.0f, 0, List.of(), List.of(new AspectInstance(Aspects.LOYALTY, 1.2f), new AspectInstance(Aspects.PROJECTILE_KNOCKBACK, 0.5f))),
    ...
    HEAVY_GREATROOT(8.0d, 1.2f, 0, List.of(), List.of(new AspectInstance(Aspects.LOYALTY, 1.5f), new AspectInstance(Aspects.PROJECTILE_KNOCKBACK, 1.0f))),
