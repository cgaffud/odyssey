...
public class OdysseyTrades {
    ...
    public static void addTrades() {
        ...
        VillagerTrades.TRADES.put(VillagerProfession.FARMER, gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ITrade[]{new ItemsForEmeraldsTrade(Items.GOLDEN_APPLE, 50, 1, 2), new EmeraldForItemsTrade(Items.GOLDEN_APPLE, 40, 1, 2)})));
    }
