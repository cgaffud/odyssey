...
public class OdysseyAnvilBlock extends FallingBlock {
    ...
    public OdysseyAnvilBlock(AbstractBlock.Properties p_i48450_1_) {
        super(p_i48450_1_);
    ...
    public INamedContainerProvider getMenuProvider(BlockState p_220052_1_, World p_220052_2_, BlockPos p_220052_3_) {
        return new SimpleNamedContainerProvider((p_220272_2_, p_220272_3_, p_220272_4_) -> {
            return new OdysseyRepairContainer(p_220272_2_, p_220272_3_, IWorldPosCallable.create(p_220052_2_, p_220052_3_));
        }, CONTAINER_TITLE);
    }
    ...
    public static BlockState damage(BlockState p_196433_0_) {
        if (p_196433_0_.is(BlockRegistry.ANVIL.get())) {
            return BlockRegistry.CHIPPED_ANVIL.get().defaultBlockState().setValue(FACING, p_196433_0_.getValue(FACING));
        } else {
            return p_196433_0_.is(BlockRegistry.CHIPPED_ANVIL.get()) ? BlockRegistry.DAMAGED_ANVIL.get().defaultBlockState().setValue(FACING, p_196433_0_.getValue(FACING)) : null;
        }
    }
