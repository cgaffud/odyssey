...
public class OdysseyBeaconTileEntity extends TileEntity implements INamedContainerProvider, ITickableTileEntity {
    /** A list of beam segments for this beacon */
    private List<OdysseyBeaconTileEntity.BeamSegment> beamSegments = Lists.newArrayList();
    private List<OdysseyBeaconTileEntity.BeamSegment> beamColorSegments = Lists.newArrayList();
    ...
    private final IIntArray beaconData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return OdysseyBeaconTileEntity.this.completion[0];
                case 1:
                    return OdysseyBeaconTileEntity.this.completion[1];
                case 2:
                    return OdysseyBeaconTileEntity.this.completion[2];
                case 3:
                    return OdysseyBeaconTileEntity.this.completion[3];
                case 4:
                    return OdysseyBeaconTileEntity.this.completion[4];
                case 5:
                    return OdysseyBeaconTileEntity.this.completion[5];
                case 6:
                    return OdysseyBeaconTileEntity.this.completion[6];
                case 7:
                    return OdysseyBeaconTileEntity.this.completion[7];
                case 8:
                    return OdysseyBeaconTileEntity.this.completion[8];
                case 9:
                    return Effect.getId(OdysseyBeaconTileEntity.this.effect);
                case 10:
                    return OdysseyBeaconTileEntity.this.amplifier;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    OdysseyBeaconTileEntity.this.completion[0] = value;
                    break;
                case 1:
                    OdysseyBeaconTileEntity.this.completion[1] = value;
                    break;
                case 2:
                    OdysseyBeaconTileEntity.this.completion[2] = value;
                    break;
                case 3:
                    OdysseyBeaconTileEntity.this.completion[3] = value;
                    break;
                case 4:
                    OdysseyBeaconTileEntity.this.completion[4] = value;
                    break;
                case 5:
                    OdysseyBeaconTileEntity.this.completion[5] = value;
                    break;
                case 6:
                    OdysseyBeaconTileEntity.this.completion[6] = value;
                    break;
                case 7:
                    OdysseyBeaconTileEntity.this.completion[7] = value;
                    break;
                case 8:
                    OdysseyBeaconTileEntity.this.completion[8] = value;
                    break;
                case 9:
                    if (!OdysseyBeaconTileEntity.this.level.isClientSide && !OdysseyBeaconTileEntity.this.beamSegments.isEmpty()) {
                        OdysseyBeaconTileEntity.this.playSound(SoundEvents.BEACON_POWER_SELECT);
                    }
                    OdysseyBeaconTileEntity.this.effect = Effect.byId(value);
                    break;
                case 10:
                    OdysseyBeaconTileEntity.this.amplifier = value;
            }
    ...
    public OdysseyBeaconTileEntity() {
    ...
    public void tick() {
        ...
        OdysseyBeaconTileEntity.BeamSegment beacontileentity$beamsegment = this.beamColorSegments.isEmpty() ? null : this.beamColorSegments.get(this.beamColorSegments.size() - 1);
        ...
        for(int i1 = 0; i1 < 10 && blockpos.getY() <= l; ++i1) {
            ...
            if (afloat != null) {
                if (this.beamColorSegments.size() <= 1) {
                    beacontileentity$beamsegment = new OdysseyBeaconTileEntity.BeamSegment(afloat);
                    ...
                    if (Arrays.equals(afloat, beacontileentity$beamsegment.colors)) {
                        ...
                        beacontileentity$beamsegment = new OdysseyBeaconTileEntity.BeamSegment(new float[]{(beacontileentity$beamsegment.colors[0] + afloat[0]) / 2.0F, (beacontileentity$beamsegment.colors[1] + afloat[1]) / 2.0F, (beacontileentity$beamsegment.colors[2] + afloat[2]) / 2.0F});
                        this.beamColorSegments.add(beacontileentity$beamsegment);
                    }
                }
            } else {
    ...
    @OnlyIn(Dist.CLIENT)
    public List<OdysseyBeaconTileEntity.BeamSegment> getBeamSegments() {
        return (List<OdysseyBeaconTileEntity.BeamSegment>)(this.blocks == 0 ? ImmutableList.of() : this.beamSegments);
    }
    ...
    public Container createMenu(int p_createMenu_1_, PlayerInventory p_createMenu_2_, PlayerEntity p_createMenu_3_) {
        return LockableTileEntity.canUnlock(p_createMenu_3_, this.lockCode, this.getDisplayName()) ? new OdysseyBeaconContainer(p_createMenu_1_, p_createMenu_2_, this.beaconData, IWorldPosCallable.create(this.level, this.getBlockPos())) : null;
    }
