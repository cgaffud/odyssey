...
public class ModBiomeMaker {
    ...
    // I dont really know what this does but it does something
    ...
    public static Biome autumnForestBiome(float depth, float scale) {
        ...
        //biomegenerationsettings$builder.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, ModFeatureGen.AUTUMN_FOREST);
