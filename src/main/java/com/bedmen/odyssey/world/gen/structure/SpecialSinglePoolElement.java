...
/** An oddc Configurable version of the SinglePoolElement. Currently, just keeps loaded templates dry.*/
public class SpecialSinglePoolElement extends StructurePoolElement {
    private static final Codec<Either<ResourceLocation, StructureTemplate>> TEMPLATE_CODEC = Codec.of(SpecialSinglePoolElement::encodeTemplate, ResourceLocation.CODEC.map(Either::left));
    public static final Codec<SpecialSinglePoolElement> CODEC = RecordCodecBuilder.create((p_210429_) -> {
        return p_210429_.group(templateCodec(), processorsCodec(), projectionCodec()).apply(p_210429_, SpecialSinglePoolElement::new);
    });
    ...
    protected static <E extends SpecialSinglePoolElement> RecordCodecBuilder<E, Holder<StructureProcessorList>> processorsCodec() {
        return StructureProcessorType.LIST_CODEC.fieldOf("processors").forGetter((p_210464_) -> {
            return p_210464_.processors;
        });
    }

    protected static <E extends SpecialSinglePoolElement> RecordCodecBuilder<E, Either<ResourceLocation, StructureTemplate>> templateCodec() {
        return TEMPLATE_CODEC.fieldOf("location").forGetter((p_210431_) -> {
            return p_210431_.template;
        });
    }

    protected SpecialSinglePoolElement(Either<ResourceLocation, StructureTemplate> p_210415_, Holder<StructureProcessorList> p_210416_, StructureTemplatePool.Projection p_210417_) {
        super(p_210417_);
        this.template = p_210415_;
        this.processors = p_210416_;
    }

    public SpecialSinglePoolElement(StructureTemplate p_210419_) {
    ...
    public StructureTemplate getTemplate(StructureTemplateManager p_227300_) {
    ...
    public StructurePoolElementType<?> getType() {
        return StructurePoolElementTypeRegistry.SPECIAL_SINGLE.get();
    }

    public String toString() {
        return "SpecialSingle[" + this.template + "]";
    }
}
