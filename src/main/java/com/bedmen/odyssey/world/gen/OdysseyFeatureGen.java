...
public class OdysseyFeatureGen {
    ...
    public static void registerFeatures() {
        ...
        PALM_TREE = Feature.TREE.configured((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.JUNGLE_LOG.defaultBlockState()), new SimpleBlockStateProvider(Blocks.STONE.defaultBlockState()), new PalmFoliagePlacer(FeatureSpread.fixed(5), FeatureSpread.fixed(0)), new LeaningTrunkPlacer(6, 1, 0), new TwoLayerFeature(1, 0, 1))).ignoreVines().build());
