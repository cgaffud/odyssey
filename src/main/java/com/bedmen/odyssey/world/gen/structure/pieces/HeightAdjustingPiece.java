...
public abstract class HeightAdjustingPiece extends RotatedStructurePiece {
    ...
    public HeightAdjustingPiece(StructurePieceType structurePieceType, int genDepth, StructureManager structureManager, ResourceLocation resourceLocation, String name, StructurePlaceSettings structurePlaceSettings, BlockPos blockPos, Rotation rotation) {
        super(structurePieceType, genDepth, structureManager, resourceLocation, name, structurePlaceSettings, blockPos, rotation);
    }
