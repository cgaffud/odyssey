...
public class OdysseyBiomeLayer implements IC0Transformer {
    ...
    public OdysseyBiomeLayer(boolean p_i232147_1_) {
    ...
    public int apply(INoiseRandom p_202726_1_, int p_202726_2_) {
        ...
        if (!isOcean(p_202726_2_) && p_202726_2_ != 14 && p_202726_2_ != 52) {
            switch(p_202726_2_) {
                case 1:
                    if (i > 0) {
