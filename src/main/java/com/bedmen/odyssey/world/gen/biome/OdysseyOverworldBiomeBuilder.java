...
public class OdysseyOverworldBiomeBuilder {
    ...
    private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{{Biomes.ICE_SPIKES, null, Biomes.SNOWY_TAIGA, null, null}, {BiomeRegistry.PRAIRIE_RESOURCE_KEY, BiomeRegistry.PRAIRIE_RESOURCE_KEY, null, null, Biomes.OLD_GROWTH_PINE_TAIGA}, {Biomes.SUNFLOWER_PLAINS, BiomeRegistry.PRAIRIE_RESOURCE_KEY, null, Biomes.OLD_GROWTH_BIRCH_FOREST, null}, {null, null, Biomes.PLAINS, Biomes.SPARSE_JUNGLE, Biomes.BAMBOO_JUNGLE}, {null, null, null, null, null}};
