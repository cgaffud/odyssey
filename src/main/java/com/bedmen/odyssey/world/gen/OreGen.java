...
public class OreGen {
    ...
    public static ConfiguredFeature<?, ?> CONFIGURED_ORE_SILVER_BURIED;
    public static PlacedFeature PLACED_ORE_SILVER;
    public static PlacedFeature PLACED_ORE_SILVER_LOWER;
    ...
    public static void registerOres() {
        ...
        CONFIGURED_ORE_SILVER_BURIED = FeatureUtils.register("ore_silver_buried", Feature.ORE.configured(new OreConfiguration(ORE_SILVER_TARGET_LIST, 9, 0.5F)));
        PLACED_ORE_SILVER = PlacementUtils.register("ore_silver", CONFIGURED_ORE_SILVER_BURIED.placed(commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(32)))));
        PLACED_ORE_SILVER_LOWER = PlacementUtils.register("ore_silver_lower", CONFIGURED_ORE_SILVER_BURIED.placed(orePlacement(CountPlacement.of(UniformInt.of(0, 1)), HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-48)))));
    }
