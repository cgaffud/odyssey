...
public class OdysseyEnchantmentCategory {
    ...
    public static final EnchantmentCategory MAIN_MELEE = EnchantmentCategory.create("MAIN_MELEE", (Item item) -> item instanceof AxeItem || item instanceof SwordItem);
    public static final EnchantmentCategory ALL_MELEE = EnchantmentCategory.create("ALL_MELEE", (Item item) -> item instanceof DiggerItem || item instanceof SwordItem);
