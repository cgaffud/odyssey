...
public class OdysseyProtectionEnchantment extends Enchantment {
    ...
    public OdysseyProtectionEnchantment(Enchantment.Rarity p_i46723_1_, ProtectionEnchantment.Type type, EnchantmentType enchantmentType, EquipmentSlotType... p_i46723_3_) {
