...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> STERLING_SILVER_HELMET = ITEMS.register("sterling_silver_helmet", () -> new ArmorItem(ModArmorMaterial.STERLING_SILVER, EquipmentSlotType.HEAD, new Item.Properties().tab(Odyssey.COMBAT)));
    public static final RegistryObject<Item> STERLING_SILVER_CHESTPLATE = ITEMS.register("sterling_silver_chestplate", () -> new ArmorItem(ModArmorMaterial.STERLING_SILVER, EquipmentSlotType.CHEST, new Item.Properties().tab(Odyssey.COMBAT)));
    public static final RegistryObject<Item> STERLING_SILVER_LEGGINGS = ITEMS.register("sterling_silver_leggings", () -> new ArmorItem(ModArmorMaterial.STERLING_SILVER, EquipmentSlotType.LEGS, new Item.Properties().tab(Odyssey.COMBAT)));
    ...
    public static final RegistryObject<Item> STERLING_SILVER_SWORD = ITEMS.register("sterling_silver_sword", () -> new SwordItem(ModItemTier.STERLING_SILVER, 7, -2.4f, new Item.Properties().tab(Odyssey.COMBAT)));
    ...
    public static final RegistryObject<Item> COPPER_HAMMER = ITEMS.register("copper_hammer", () -> new HammerItem(ModItemTier.COPPER, 8, -3.2f, new Item.Properties().tab(Odyssey.COMBAT)));
    ...
    public static final RegistryObject<Item> STERLING_SILVER_AXE = ITEMS.register("sterling_silver_axe", () -> new AxeItem(ModItemTier.STERLING_SILVER, 9.0f, -3.0f, new Item.Properties().tab(Odyssey.TOOLS)));
    ...
    public static final RegistryObject<Item> STERLING_SILVER_PICKAXE = ITEMS.register("sterling_silver_pickaxe", () -> new PickaxeItem(ModItemTier.STERLING_SILVER, 5, -2.8f, new Item.Properties().tab(Odyssey.TOOLS)));
    ...
    public static final RegistryObject<Item> STERLING_SILVER_SHOVEL = ITEMS.register("sterling_silver_shovel", () -> new ShovelItem(ModItemTier.STERLING_SILVER, 4.5f, -2.6f, new Item.Properties().tab(Odyssey.TOOLS)));
    ...
    public static final RegistryObject<Item> STERLING_SILVER_HOE = ITEMS.register("sterling_silver_hoe", () -> new HoeItem(ModItemTier.STERLING_SILVER, 4, -2.0f, new Item.Properties().tab(Odyssey.TOOLS)));
    ...
    public static final RegistryObject<Item> NETHERITE_BOW = ITEMS.register("netherite_bow", () -> new NewBowItem((new Item.Properties()).durability(1016).tab(Odyssey.COMBAT).fireResistant(), 1.0D));
    ...
    public static final RegistryObject<Item> NETHERITE_CROSSBOW = ITEMS.register("netherite_crossbow", () -> new NewCrossbowItem((new Item.Properties()).stacksTo(1).tab(Odyssey.COMBAT).durability(862).fireResistant(), 1.0D));
    ...
    public static final RegistryObject<Item> SERPENT_TRIDENT = ITEMS.register("serpent_trident", () -> new NewTridentItem((new Item.Properties()).durability(750).fireResistant().tab(Odyssey.COMBAT), 11.0D));
    ...
    public static final RegistryObject<Item> SERPENT_SHIELD = ITEMS.register("serpent_shield", () -> new NewShieldItem((new Item.Properties()).durability(1000).fireResistant().tab(Odyssey.COMBAT), 10.0f, () -> {NonNullList<Item> nonNullList = NonNullList.create(); nonNullList.add(SERPENT_SCALE.get()); return nonNullList;}));


    //Spawn Eggs
    public static final RegistryObject<Item> ARCTIHORN_SPAWN_EGG = ITEMS.register("arctihorn_spawn_egg", () -> new ModSpawnEggItem(EntityTypeRegistry.ARCTIHORN, 0x6e7d90, 0x8ab5eb, (new Item.Properties()).tab(Odyssey.SPAWN_EGGS)));
    public static final RegistryObject<Item> WEREWOLF_SPAWN_EGG = ITEMS.register("werewolf_spawn_egg", () -> new ModSpawnEggItem(EntityTypeRegistry.WEREWOLF, 0x000000, 0x000000, (new Item.Properties()).tab(Odyssey.SPAWN_EGGS)));
}