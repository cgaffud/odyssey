...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> NATURAL_COPPER_ORE = BLOCKS.register("natural_copper_ore", () -> new OreBlock(AbstractBlock.Properties.create(Material.ROCK).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(3.0F, 3.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> FORTUNELESS_COPPER_ORE = BLOCKS.register("fortuneless_copper_ore", () -> new OreBlock(AbstractBlock.Properties.create(Material.ROCK).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(3.0F, 3.0F).sound(SoundType.STONE)));
