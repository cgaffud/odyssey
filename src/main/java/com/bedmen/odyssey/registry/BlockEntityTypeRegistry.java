...
public class BlockEntityTypeRegistry {
    ...
    public static final RegistryObject<BlockEntityType<GetJumpedByBanditsBlockEntity>> GET_JUMPED_BY_BANDITS_BLOCK = BLOCK_ENTITY_TYPES.register("get_jumped_by_bandits_block", () -> BlockEntityType.Builder.of(GetJumpedByBanditsBlockEntity::new, BlockRegistry.GET_JUMPED_BY_BANDITS_BLOCK.get()).build(null));
}