...
public class BlockEntityTypeRegistry {
    ...
    public static final RegistryObject<BlockEntityType<InfusionPedestalBlockEntity>> INFUSION_PEDESTAL = BLOCK_ENTITY_TYPES.register("infusion_pedestal", () -> BlockEntityType.Builder.of(InfusionPedestalBlockEntity::new, BlockRegistry.INFUSION_PEDESTAL.get(), BlockRegistry.INFUSER.get()).build(null));
}