...
public class EntityTypeRegistry {
    ...
    public static final RegistryObject<EntityType<WeaverEntity>> WEAVER = ENTITY_TYPE.register("weaver", () -> EntityType.Builder.<WeaverEntity>of(WeaverEntity::new, EntityClassification.MONSTER).sized(1.4F, 0.9F).clientTrackingRange(10).build(new ResourceLocation("weaver").toString()));
