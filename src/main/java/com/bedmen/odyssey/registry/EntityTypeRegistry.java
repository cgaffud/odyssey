...
//    public static final RegistryObject<EntityType<Arctihorn>> ARCTIHORN = ENTITY_TYPE.register("arctihorn", () -> EntityType.Builder.<Arctihorn>of(Arctihorn::new, MobCategory.MONSTER).sized(0.8F, 0.8F).clientTrackingRange(12).build(new ResourceLocation("arctihorn").toString()));
    ...
    public static final RegistryObject<EntityType<CrossbowSkeleton>> CROSSBOW_SKELETON = ENTITY_TYPE.register("crossbow_skeleton", () -> EntityType.Builder.<CrossbowSkeleton>of(CrossbowSkeleton::new, MobCategory.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8).build(new ResourceLocation("crossbow_skeleton").toString()));
