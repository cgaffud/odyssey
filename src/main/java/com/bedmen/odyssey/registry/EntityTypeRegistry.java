...
//    public static final RegistryObject<EntityType<Arctihorn>> ARCTIHORN = ENTITY_TYPE.register("arctihorn", () -> EntityType.Builder.<Arctihorn>of(Arctihorn::new, MobCategory.MONSTER).sized(0.8F, 0.8F).clientTrackingRange(12).build(new ResourceLocation("arctihorn").toString()));
    ...
    // ## Mineral Leviathan
    public static final RegistryObject<EntityType<MineralLeviathanMaster>> MINERAL_LEVIATHAN_MASTER = ENTITY_TYPE.register("mineral_leviathan_master", () -> EntityType.Builder.of(MineralLeviathanMaster::new, MobCategory.MONSTER).sized(0.0F, 0.0F).fireImmune().clientTrackingRange(20).build(new ResourceLocation(Odyssey.MOD_ID, "mineral_leviathan_master").toString()));
    public static final RegistryObject<EntityType<Segment>> MINERAL_LEVIATHAN_HEAD_2 = ENTITY_TYPE.register("mineral_leviathan_head_2", () -> EntityType.Builder.<Segment>of(Segment::new, MobCategory.MONSTER).sized(2.0F, 2.0F).fireImmune().clientTrackingRange(20).build(new ResourceLocation(Odyssey.MOD_ID, "mineral_leviathan_head_2").toString()));
    public static final RegistryObject<EntityType<Segment>> MINERAL_LEVIATHAN_BODY_2 = ENTITY_TYPE.register("mineral_leviathan_body_2", () -> EntityType.Builder.<Segment>of(Segment::new, MobCategory.MONSTER).sized(2.0F, 2.0F).fireImmune().clientTrackingRange(20).build(new ResourceLocation(Odyssey.MOD_ID, "mineral_leviathan_body_2").toString()));
