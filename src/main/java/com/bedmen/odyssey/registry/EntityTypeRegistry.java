...
public class EntityTypeRegistry {
    ...
    //Mobs
//    public static final RegistryObject<EntityType<Lupine>> LUPINE = ENTITY_TYPE.register("lupine", () -> EntityType.Builder.<Lupine>of(Lupine::new, OdysseyBiomeEntitySpawn.HARD_BIOME).sized(0.6F, 0.85F).clientTrackingRange(10).build(new ResourceLocation(Odyssey.MOD_ID, "lupine").toString()));
//    public static final RegistryObject<EntityType<Arctihorn>> ARCTIHORN = ENTITY_TYPE.register("arctihorn", () -> EntityType.Builder.<Arctihorn>of(Arctihorn::new, MobCategory.MONSTER).sized(0.8F, 0.8F).clientTrackingRange(12).build(new ResourceLocation(Odyssey.MOD_ID, "arctihorn").toString()));
...
//    public static final RegistryObject<EntityType<OdysseyTrident>> TRIDENT = ENTITY_TYPE.register("trident", () -> EntityType.Builder.<OdysseyTrident>of(OdysseyTrident::new, MobCategory.MISC).sized(0.5f,0.5f).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(Odyssey.MOD_ID, "trident").toString()));
//    public static final RegistryObject<EntityType<PermafrostIcicle>> PERMAFROST_ICICLE = ENTITY_TYPE.register("permafrost_icicle", () -> EntityType.Builder.<PermafrostIcicle>of(PermafrostIcicle::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(10).build(new ResourceLocation(Odyssey.MOD_ID, "permafrost_icicle").toString()));
