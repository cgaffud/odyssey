...
//    public static final RegistryObject<EntityType<Arctihorn>> ARCTIHORN = ENTITY_TYPE.register("arctihorn", () -> EntityType.Builder.<Arctihorn>of(Arctihorn::new, MobCategory.MONSTER).sized(0.8F, 0.8F).clientTrackingRange(12).build(new ResourceLocation("arctihorn").toString()));
    ...
    // ## Mineral Leviathan
    public static final RegistryObject<EntityType<MineralLeviathanMaster2>> MINERAL_LEVIATHAN_MASTER_2 = ENTITY_TYPE.register("mineral_leviathan_master_2", () -> EntityType.Builder.<MineralLeviathanMaster2>of(MineralLeviathanMaster2::new, MobCategory.MONSTER).sized(0.0F, 0.0F).fireImmune().clientTrackingRange(32).build(new ResourceLocation(Odyssey.MOD_ID, "mineral_leviathan_master_2").toString()));
    public static final RegistryObject<EntityType<MineralLeviathanHead2>> MINERAL_LEVIATHAN_HEAD_2 = ENTITY_TYPE.register("mineral_leviathan_head_2", () -> EntityType.Builder.<MineralLeviathanHead2>of(MineralLeviathanHead2::new, MobCategory.MONSTER).sized(2.0F, 2.0F).fireImmune().clientTrackingRange(32).build(new ResourceLocation(Odyssey.MOD_ID, "mineral_leviathan_head_2").toString()));
    public static final RegistryObject<EntityType<MineralLeviathanBody2>> MINERAL_LEVIATHAN_BODY_2 = ENTITY_TYPE.register("mineral_leviathan_body_2", () -> EntityType.Builder.<MineralLeviathanBody2>of(MineralLeviathanBody2::new, MobCategory.MONSTER).sized(2.0F, 2.0F).fireImmune().clientTrackingRange(32).build(new ResourceLocation(Odyssey.MOD_ID, "mineral_leviathan_body_2").toString()));

    public static final RegistryObject<EntityType<MineralLeviathanHead>> MINERAL_LEVIATHAN = ENTITY_TYPE.register("mineral_leviathan", () -> EntityType.Builder.of(MineralLeviathanHead::new, MobCategory.MONSTER).sized(2.0F, 2.0F).fireImmune().clientTrackingRange(20).build(new ResourceLocation(Odyssey.MOD_ID, "mineral_leviathan").toString()));
