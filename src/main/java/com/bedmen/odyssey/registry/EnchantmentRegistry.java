...
public class EnchantmentRegistry {
    ...
    public static final RegistryObject<Enchantment> TORRENT = ENCHANTMENTS.register("torrent", () -> new OdysseyDamageEnchantment(Enchantment.Rarity.RARE, OdysseyDamageEnchantment.DamageType.HYDROPHOBIC, EquipmentSlot.MAINHAND));
