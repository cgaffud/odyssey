...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> WEAVER_FANG_DAGGER = ITEMS.register("weaver_fang_dagger", () -> new AspectMeleeItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE), OdysseyTiers.STONE, MeleeWeaponClass.DAGGER, 6f, List.of(), List.of(new AspectInstance(Aspects.COBWEB_CHANCE, 0.1f))));
