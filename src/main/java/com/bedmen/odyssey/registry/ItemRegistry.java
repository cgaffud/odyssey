...
public class ItemRegistry {
    ...
    // ## Tier 3
    public static final RegistryObject<Item> NETHERITE_MACE = ITEMS.register("netherite_mace", () -> new AspectMeleeItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE), OdysseyTiers.NETHERITE, MeleeWeaponClass.MACE, 11f, List.of(), List.of()));
    ...
    public static final RegistryObject<Item> BONE_REPEATER = ITEMS.register("bone_repeater", () -> new AspectBowItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), OdysseyTiers.BONE, 1.2f, 16, List.of(new AspectInstance(Aspects.REPEAT)), List.of()));
    ...
    public static final RegistryObject<Item> GREATROOT_REPEATER = ITEMS.register("greatroot_repeater", () -> new AspectBowItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), OdysseyTiers.GREATROOT,1.5f, 14, List.of(new AspectInstance(Aspects.REPEAT)), List.of()));
    public static final RegistryObject<Item> GREATROOT_SNIPER_BOW = ITEMS.register("greatroot_sniper_bow", () -> new AspectBowItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), OdysseyTiers.GREATROOT,1.5f, 20, List.of(new AspectInstance(Aspects.SPYGLASS)), List.of(new AspectInstance(Aspects.ACCURACY, 1.0f), new AspectInstance(Aspects.MAX_CHARGE_TIME, 0.5f))));
    public static final RegistryObject<Item> GREATROOT_SLUG_BOW = ITEMS.register("greatroot_slug_bow", () -> new AspectCrossbowItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), OdysseyTiers.GREATROOT,1.8f, 25, List.of(), List.of(new AspectInstance(Aspects.PROJECTILE_KNOCKBACK, 1.0f))));
    public static final RegistryObject<Item> GREATROOT_SHOT_BOW = ITEMS.register("greatroot_shot_bow", () -> new AspectCrossbowItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), OdysseyTiers.GREATROOT,1.8f, 25, List.of(), List.of(new AspectInstance(Aspects.MULTISHOT, 2.0f))));
    ...
    public static final RegistryObject<Item> CHICKEN_HELMET = ITEMS.register("chicken_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CHICKEN, EquipmentSlot.HEAD, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.0f))));
    public static final RegistryObject<Item> CHICKEN_CHESTPLATE = ITEMS.register("chicken_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CHICKEN, EquipmentSlot.CHEST, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.0f))));
    public static final RegistryObject<Item> CHICKEN_LEGGINGS = ITEMS.register("chicken_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CHICKEN, EquipmentSlot.LEGS, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.0f))));
    public static final RegistryObject<Item> CHICKEN_BOOTS = ITEMS.register("chicken_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CHICKEN, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.0f))));
    ...
    public static final RegistryObject<Item> GLIDER_HELMET = ITEMS.register("glider_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.GLIDER, EquipmentSlot.HEAD, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.5f))));
    public static final RegistryObject<Item> GLIDER_CHESTPLATE = ITEMS.register("glider_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.GLIDER, EquipmentSlot.CHEST, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.5f))));
    public static final RegistryObject<Item> GLIDER_LEGGINGS = ITEMS.register("glider_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.GLIDER, EquipmentSlot.LEGS, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.5f))));
    public static final RegistryObject<Item> GLIDER_BOOTS = ITEMS.register("glider_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.GLIDER, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 1.5f))));
    ...
    public static final RegistryObject<Item> TURTLE_CHESTPLATE = ITEMS.register("turtle_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.TURTLE, EquipmentSlot.CHEST, List.of(), List.of(new AspectInstance(Aspects.RESPIRATION, 1.0f))));
    public static final RegistryObject<Item> TURTLE_LEGGINGS = ITEMS.register("turtle_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.TURTLE, EquipmentSlot.LEGS, List.of(), List.of(new AspectInstance(Aspects.SWIM_SPEED, 0.5f))));
    public static final RegistryObject<Item> TURTLE_BOOTS = ITEMS.register("turtle_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.TURTLE, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.SWIM_SPEED, 0.5f))));
    ...
    public static final RegistryObject<Item> ZEPHYR_HELMET = ITEMS.register("zephyr_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ZEPHYR, EquipmentSlot.HEAD, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 2.0f))));
    public static final RegistryObject<Item> ZEPHYR_CHESTPLATE = ITEMS.register("zephyr_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ZEPHYR, EquipmentSlot.CHEST, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 2.0f))));
    public static final RegistryObject<Item> ZEPHYR_LEGGINGS = ITEMS.register("zephyr_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ZEPHYR, EquipmentSlot.LEGS, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 2.0f))));
    public static final RegistryObject<Item> ZEPHYR_BOOTS = ITEMS.register("zephyr_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ZEPHYR, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.FEATHER_FALLING, 2.0f))));
    
    public static final RegistryObject<Item> STERLING_SILVER_HELMET = ITEMS.register("sterling_silver_helmet", () -> new ArmorItem(OdysseyArmorMaterial.STERLING_SILVER, EquipmentSlot.HEAD, new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR)));
    public static final RegistryObject<Item> STERLING_SILVER_CHESTPLATE = ITEMS.register("sterling_silver_chestplate", () -> new ArmorItem(OdysseyArmorMaterial.STERLING_SILVER, EquipmentSlot.CHEST, new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR)));
    public static final RegistryObject<Item> STERLING_SILVER_LEGGINGS = ITEMS.register("sterling_silver_leggings", () -> new ArmorItem(OdysseyArmorMaterial.STERLING_SILVER, EquipmentSlot.LEGS, new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR)));
    public static final RegistryObject<Item> STERLING_SILVER_BOOTS = ITEMS.register("sterling_silver_boots", () -> new ArmorItem(OdysseyArmorMaterial.STERLING_SILVER, EquipmentSlot.FEET, new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR)));
    ...
    public static final RegistryObject<Item> DIAMOND_SWORD = ITEMS_VANILLA.register("diamond_sword", () -> new AspectMeleeItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyTiers.DIAMOND, MeleeWeaponClass.SWORD, 8f, List.of(), List.of()));
    public static final RegistryObject<Item> NETHERITE_SWORD = ITEMS_VANILLA.register("netherite_sword", () -> new AspectMeleeItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyTiers.NETHERITE, MeleeWeaponClass.SWORD, 9f, List.of(), List.of()));
    ...
    public static final RegistryObject<Item> GOLDEN_AXE = ITEMS_VANILLA.register("golden_axe", () -> new AspectAxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.GOLD, MeleeWeaponClass.AXE.withBetterAttackSpeed(), 4.0f, List.of(), List.of()));
    public static final RegistryObject<Item> DIAMOND_AXE = ITEMS_VANILLA.register("diamond_axe", () -> new AspectAxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.AXE, 7.0f, List.of(), List.of()));
    public static final RegistryObject<Item> NETHERITE_AXE = ITEMS_VANILLA.register("netherite_axe", () -> new AspectAxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.AXE, 8.0f, List.of(), List.of()));
    ...
    public static final RegistryObject<Item> GOLDEN_PICKAXE = ITEMS_VANILLA.register("golden_pickaxe", () -> new AspectPickaxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.GOLD, MeleeWeaponClass.PICKAXE.withBetterAttackSpeed(), 3.0f, List.of(), List.of()));
    public static final RegistryObject<Item> DIAMOND_PICKAXE = ITEMS_VANILLA.register("diamond_pickaxe", () -> new AspectPickaxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.PICKAXE, 6.0f, List.of(), List.of()));
    public static final RegistryObject<Item> NETHERITE_PICKAXE = ITEMS_VANILLA.register("netherite_pickaxe", () -> new AspectPickaxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.PICKAXE, 7.0f, List.of(), List.of()));
    ...
    public static final RegistryObject<Item> GOLDEN_SHOVEL = ITEMS_VANILLA.register("golden_shovel", () -> new AspectShovelItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.GOLD, MeleeWeaponClass.SHOVEL.withBetterAttackSpeed(), 2.5f, List.of(), List.of()));
    public static final RegistryObject<Item> DIAMOND_SHOVEL = ITEMS_VANILLA.register("diamond_shovel", () -> new AspectShovelItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.SHOVEL, 5.5f, List.of(), List.of()));
    public static final RegistryObject<Item> NETHERITE_SHOVEL = ITEMS_VANILLA.register("netherite_shovel", () -> new AspectShovelItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.SHOVEL, 6.5f, List.of(), List.of()));
    ...
    public static final RegistryObject<Item> GOLDEN_HOE = ITEMS_VANILLA.register("golden_hoe", () -> new AspectHoeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.GOLD, MeleeWeaponClass.HOE.withBetterAttackSpeed(), 2.0f, List.of(), List.of()));
    public static final RegistryObject<Item> DIAMOND_HOE = ITEMS_VANILLA.register("diamond_hoe", () -> new AspectHoeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.HOE, 5.0f, List.of(), List.of()));
    public static final RegistryObject<Item> NETHERITE_HOE = ITEMS_VANILLA.register("netherite_hoe", () -> new AspectHoeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.HOE, 6.0f, List.of(), List.of()));
    ...
    public static final RegistryObject<Item> DIAMOND_HELMET = ITEMS_VANILLA.register("diamond_helmet", () -> new ArmorItem(OdysseyArmorMaterial.DIAMOND, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> DIAMOND_CHESTPLATE = ITEMS_VANILLA.register("diamond_chestplate", () -> new ArmorItem(OdysseyArmorMaterial.DIAMOND, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> DIAMOND_LEGGINGS = ITEMS_VANILLA.register("diamond_leggings", () -> new ArmorItem(OdysseyArmorMaterial.DIAMOND, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> DIAMOND_BOOTS = ITEMS_VANILLA.register("diamond_boots", () -> new ArmorItem(OdysseyArmorMaterial.DIAMOND, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    ...
    public static final RegistryObject<Item> NETHERITE_HELMET = ITEMS_VANILLA.register("netherite_helmet", () -> new ArmorItem(OdysseyArmorMaterial.NETHERITE, EquipmentSlot.HEAD, new Item.Properties().fireResistant().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> NETHERITE_CHESTPLATE = ITEMS_VANILLA.register("netherite_chestplate", () -> new ArmorItem(OdysseyArmorMaterial.NETHERITE, EquipmentSlot.CHEST, new Item.Properties().fireResistant().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> NETHERITE_LEGGINGS = ITEMS_VANILLA.register("netherite_leggings", () -> new ArmorItem(OdysseyArmorMaterial.NETHERITE, EquipmentSlot.LEGS, new Item.Properties().fireResistant().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> NETHERITE_BOOTS = ITEMS_VANILLA.register("netherite_boots", () -> new ArmorItem(OdysseyArmorMaterial.NETHERITE, EquipmentSlot.FEET, new Item.Properties().fireResistant().tab(CreativeModeTab.TAB_COMBAT)));
