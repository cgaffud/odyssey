...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> FLINT_SPEAR = ITEMS.register("flint_spear", () -> new SpearItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE), OdysseyTiers.FLINT, SpearType.FLINT));
    ...
    public static final RegistryObject<Item> AMETHYST_SPEAR = ITEMS.register("amethyst_spear", () -> new SpearItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE), OdysseyTiers.AMETHYST, SpearType.AMETHYST));
    ...
    public static final RegistryObject<Item> BOWN = ITEMS.register("bown", () -> new AspectBowItem((new Item.Properties()).durability(OdysseyTiers.BONE.getUses()).tab(OdysseyCreativeModeTab.RANGED),1.2f, 20, List.of(new AspectInstance(Aspects.REPEAT)), List.of(new AspectInstance(Aspects.PIERCING, 1.0f), new AspectInstance(Aspects.PROJECTILE_KNOCKBACK, 0.5f))));
    public static final RegistryObject<Item> VOID_BOW = ITEMS.register("void_bow", () -> new ConditionalAmpBowItem.NumericalItem((new Item.Properties()).durability(OdysseyTiers.ULTRA_2.getUses()).tab(OdysseyCreativeModeTab.RANGED), 1.35f, 20, List.of(), List.of(new AspectInstance(Aspects.VOID_STRENGTH, 0.4f)), 9));
    ...
    public static final RegistryObject<Item> BOW = ITEMS_VANILLA.register("bow", () -> new AspectBowItem((new Item.Properties()).durability(125).tab(CreativeModeTab.TAB_COMBAT), 1.0f, 20, List.of(), List.of()));
    public static final RegistryObject<Item> CROSSBOW = ITEMS_VANILLA.register("crossbow", () -> new AspectCrossbowItem((new Item.Properties()).durability(OdysseyTiers.IRON.getUses()).tab(CreativeModeTab.TAB_COMBAT), 1.25f, 25, List.of(), List.of()));
