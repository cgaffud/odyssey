...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> STONE_SPEAR = ITEMS.register("stone_spear", () -> new SpearItem(new Item.Properties().durability(100).tab(OdysseyCreativeModeTab.MELEE), SpearType.STONE));
