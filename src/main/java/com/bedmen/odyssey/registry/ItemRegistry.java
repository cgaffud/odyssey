...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> BRICK_HELMET = ITEMS.register("brick_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.HEAD, List.of(), List.of(new AspectInstance(Aspects.BLAST_PROTECTION, 0.5f))));
    public static final RegistryObject<Item> BRICK_CHESTPLATE = ITEMS.register("brick_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.CHEST, List.of(), List.of(new AspectInstance(Aspects.BLAST_PROTECTION, 0.5f))));
    public static final RegistryObject<Item> BRICK_LEGGINGS = ITEMS.register("brick_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.LEGS, List.of(), List.of(new AspectInstance(Aspects.BLAST_PROTECTION, 0.5f))));
    public static final RegistryObject<Item> BRICK_BOOTS = ITEMS.register("brick_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.BLAST_PROTECTION, 0.5f))));
