...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> VOID_BOW = ITEMS.register("void_bow", () -> new ConditionalAmpBowItem.NumericalItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), OdysseyTiers.ULTRA_2, 1.35f, 20, List.of(), List.of(new AspectInstance<>(Aspects.VOID_STRENGTH, 1.0f)), 9));
    ...
    public static final RegistryObject<Item> CREEPER_SPAWN_EGG = ITEMS.register("creeper_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.CREEPER, 894731, 0, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
