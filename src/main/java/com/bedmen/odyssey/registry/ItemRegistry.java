...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> PALM_BOAT = ITEMS.register("palm_boat", () -> new BoatItem(Boat.Type.OAK, (new Item.Properties()).stacksTo(1).tab(OdysseyCreativeModeTab.WOOD)));
