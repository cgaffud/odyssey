...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> BATTLE_PICKAXE = ITEMS.register("battle_pickaxe", () -> new AspectPickaxeItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE).rarity(OdysseyRarity.UNCRAFTABLE_EQUIPMENT), OdysseyTiers.UNCRAFTABLE_1, MeleeWeaponClass.BATTLE_AXE,8f, List.of(), List.of(new AspectInstance(Aspects.FATAL_HIT, 8.0f))));
    ...
    public static final RegistryObject<Item> SLEDGEAXE = ITEMS.register("sledgeaxe", () -> new AspectMeleeItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE).rarity(OdysseyRarity.UNCRAFTABLE_EQUIPMENT), OdysseyTiers.UNCRAFTABLE_2, MeleeWeaponClass.BATTLE_AXE,  9.5f, List.of(), List.of(new AspectInstance(Aspects.FATAL_HIT, 8.0f), new AspectInstance(Aspects.SMITE_DAMAGE, 1.0f))));
