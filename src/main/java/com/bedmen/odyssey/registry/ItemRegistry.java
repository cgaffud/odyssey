...
public class ItemRegistry {
    ...
    // # Innate Modifiers
    public static final List<AspectInstance> DIAMOND_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.DURABILITY, 2.0f));
    public static final List<AspectInstance> NETHERITE_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.BURN_PROOF));
    ...
    public static final RegistryObject<Item> THORNMAIL = ITEMS.register("thornmail", () -> new Item((new Item.Properties()).tab(OdysseyCreativeModeTab.MATERIALS)));
    public static final RegistryObject<Item> PARKA_HIDE = ITEMS.register("parka_hide", () -> new Item((new Item.Properties()).tab(OdysseyCreativeModeTab.MATERIALS)));
    ...
    public static final RegistryObject<Item> WARM_BROTH = ITEMS.register("warm_broth", () -> new TemperatureFoodItem((new Item.Properties()).tab(OdysseyCreativeModeTab.FOOD).food(OdysseyFood.WARM_BROTH), 0.1f, true));
    public static final RegistryObject<Item> SNOW_CONE = ITEMS.register("snow_cone", () -> new TemperatureFoodItem((new Item.Properties()).tab(OdysseyCreativeModeTab.FOOD).food(OdysseyFood.SNOW_CONE), -0.1f, false));
    public static final RegistryObject<Item> BEEF_STEW = ITEMS.register("beef_stew", () -> new TemperatureFoodItem((new Item.Properties()).tab(OdysseyCreativeModeTab.FOOD).food(OdysseyFood.BEEF_STEW), 0.2f, true));
    public static final RegistryObject<Item> VEGETABLE_STEW = ITEMS.register("vegetable_stew", () -> new TemperatureFoodItem((new Item.Properties()).tab(OdysseyCreativeModeTab.FOOD).food(OdysseyFood.VEGETABLE_STEW), 0.2f, true));
    ...
    public static final RegistryObject<Item> GET_JUMPED_BY_BANDITS_BLOCK = ITEMS.register("get_jumped_by_bandits_block", () -> new BlockItem(BlockRegistry.GET_JUMPED_BY_BANDITS_BLOCK.get(), (new Item.Properties()).tab(OdysseyCreativeModeTab.MISC)));
    ...
    public static final RegistryObject<Item> DIAMOND_MACE = ITEMS.register("diamond_mace", () -> new AspectMeleeItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE), OdysseyTiers.DIAMOND, MeleeWeaponClass.MACE, 10f, List.of(), DIAMOND_INNATE_MODIFIERS));
    ...
    // ## Tier 3
    public static final RegistryObject<Item> NETHERITE_MACE = ITEMS.register("netherite_mace", () -> new AspectMeleeItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE), OdysseyTiers.NETHERITE, MeleeWeaponClass.MACE, 11f, List.of(), NETHERITE_INNATE_MODIFIERS));
    ...
    public static final RegistryObject<Item> GREATROOT_CROSSBOW = ITEMS.register("greatroot_crossbow", () -> new AspectCrossbowItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), OdysseyTiers.GREATROOT,1.9f, 25, List.of(), DIAMOND_INNATE_MODIFIERS));
    ...
    public static final RegistryObject<Item> MARINE_TRIDENT = ITEMS.register("marine_trident", () -> new SpearItem(new Item.Properties().tab(OdysseyCreativeModeTab.MELEE), OdysseyTiers.MARINE, MeleeWeaponClass.TRIDENT, ThrowableTypes.MARINE_TRIDENT));
    ...
    public static final RegistryObject<Item> ETHEREAL_ARROW = ITEMS.register("ethereal_arrow", () -> new AspectArrowItem((new Item.Properties()).tab(OdysseyCreativeModeTab.RANGED), ArrowType.ETHEREAL, true));
    ...
    public static final List<AspectInstance> CACTUS_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.THORNS, 1.0f));
    public static final RegistryObject<Item> CACTUS_HELMET = ITEMS.register("cactus_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CACTUS, EquipmentSlot.HEAD, List.of(), CACTUS_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> CACTUS_CHESTPLATE = ITEMS.register("cactus_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CACTUS, EquipmentSlot.CHEST, List.of(), CACTUS_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> CACTUS_LEGGINGS = ITEMS.register("cactus_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CACTUS, EquipmentSlot.LEGS, List.of(), CACTUS_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> CACTUS_BOOTS = ITEMS.register("cactus_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CACTUS, EquipmentSlot.FEET, List.of(), CACTUS_ARMOR_INNATE_MODIFIERS));

    public static final List<AspectInstance> CHICKEN_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.FEATHER_FALLING, 2.0f));
    ...
    public static final RegistryObject<Item> CHICKEN_LEGGINGS = ITEMS.register("chicken_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CHICKEN, EquipmentSlot.LEGS, List.of(), CHICKEN_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> CHICKEN_BOOTS = ITEMS.register("chicken_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.CHICKEN, EquipmentSlot.FEET, List.of(), CHICKEN_ARMOR_INNATE_MODIFIERS));

    public static final List<AspectInstance> FUR_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.ICE_PROTECTION, 0.5f), new AspectInstance(Aspects.WARMTH, 1.0f));
    public static final RegistryObject<Item> FUR_HELMET = ITEMS.register("fur_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.FUR, EquipmentSlot.HEAD, List.of(), FUR_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> FUR_CHESTPLATE = ITEMS.register("fur_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.FUR, EquipmentSlot.CHEST, List.of(), FUR_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> FUR_LEGGINGS = ITEMS.register("fur_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.FUR, EquipmentSlot.LEGS, List.of(), FUR_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> FUR_BOOTS = ITEMS.register("fur_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.FUR, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.ICE_PROTECTION, 0.5f), new AspectInstance(Aspects.WARMTH, 1.0f), new AspectInstance(Aspects.SNOWSHOE))));

    public static final List<AspectInstance> BRICK_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.BLAST_PROTECTION, 0.5f));
    public static final RegistryObject<Item> BRICK_HELMET = ITEMS.register("brick_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.HEAD, List.of(), BRICK_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> BRICK_CHESTPLATE = ITEMS.register("brick_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.CHEST, List.of(), BRICK_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> BRICK_LEGGINGS = ITEMS.register("brick_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.LEGS, List.of(), BRICK_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> BRICK_BOOTS = ITEMS.register("brick_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.BRICK, EquipmentSlot.FEET, List.of(), BRICK_ARMOR_INNATE_MODIFIERS));

    public static final List<AspectInstance> GLIDER_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.FEATHER_FALLING, 3.0f));
    ...
    public static final RegistryObject<Item> GLIDER_LEGGINGS = ITEMS.register("glider_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.GLIDER, EquipmentSlot.LEGS, List.of(), GLIDER_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> GLIDER_BOOTS = ITEMS.register("glider_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.GLIDER, EquipmentSlot.FEET, List.of(), GLIDER_ARMOR_INNATE_MODIFIERS));
    ...
    // ### Tier 2
    public static final List<AspectInstance> THORNMAIL_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.THORNS, 1.5f));
    public static final RegistryObject<Item> THORNMAIL_HELMET = ITEMS.register("thornmail_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.THORNMAIL, EquipmentSlot.HEAD, List.of(), THORNMAIL_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> THORNMAIL_CHESTPLATE = ITEMS.register("thornmail_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.THORNMAIL, EquipmentSlot.CHEST, List.of(), THORNMAIL_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> THORNMAIL_LEGGINGS = ITEMS.register("thornmail_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.THORNMAIL, EquipmentSlot.LEGS, List.of(), THORNMAIL_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> THORNMAIL_BOOTS = ITEMS.register("thornmail_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.THORNMAIL, EquipmentSlot.FEET, List.of(), THORNMAIL_ARMOR_INNATE_MODIFIERS));

    public static final List<AspectInstance> PARKA_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.ICE_PROTECTION, 1.0f), new AspectInstance(Aspects.WARMTH, 1.5f));
    public static final RegistryObject<Item> PARKA_HELMET = ITEMS.register("parka_helmet", () -> new DyeableAspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.PARKA, EquipmentSlot.HEAD, List.of(), PARKA_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> PARKA_CHESTPLATE = ITEMS.register("parka_chestplate", () -> new DyeableAspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.PARKA, EquipmentSlot.CHEST, List.of(), PARKA_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> PARKA_LEGGINGS = ITEMS.register("parka_leggings", () -> new DyeableAspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.PARKA, EquipmentSlot.LEGS, List.of(), PARKA_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> PARKA_BOOTS = ITEMS.register("parka_boots", () -> new DyeableAspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.PARKA, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.ICE_PROTECTION, 1.0f), new AspectInstance(Aspects.WARMTH, 1.5f), new AspectInstance(Aspects.SNOWSHOE))));
    ...
    public static final List<AspectInstance> REINFORCED_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.BLAST_PROTECTION, 1.0f));
    public static final RegistryObject<Item> REINFORCED_HELMET = ITEMS.register("reinforced_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.REINFORCED, EquipmentSlot.HEAD, List.of(), REINFORCED_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> REINFORCED_CHESTPLATE = ITEMS.register("reinforced_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.REINFORCED, EquipmentSlot.CHEST, List.of(), REINFORCED_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> REINFORCED_LEGGINGS = ITEMS.register("reinforced_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.REINFORCED, EquipmentSlot.LEGS, List.of(), REINFORCED_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> REINFORCED_BOOTS = ITEMS.register("reinforced_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.REINFORCED, EquipmentSlot.FEET, List.of(), REINFORCED_ARMOR_INNATE_MODIFIERS));

    public static final List<AspectInstance> ARCTIC_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.FIRE_PROTECTION, 1.0f), new AspectInstance(Aspects.COOLING, 1.0f));
    public static final RegistryObject<Item> ARCTIC_HELMET = ITEMS.register("arctic_helmet", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ARCTIC, EquipmentSlot.HEAD, List.of(), ARCTIC_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> ARCTIC_CHESTPLATE = ITEMS.register("arctic_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ARCTIC, EquipmentSlot.CHEST, List.of(), ARCTIC_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> ARCTIC_LEGGINGS = ITEMS.register("arctic_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ARCTIC, EquipmentSlot.LEGS, List.of(), ARCTIC_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> ARCTIC_BOOTS = ITEMS.register("arctic_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ARCTIC, EquipmentSlot.FEET, List.of(), ARCTIC_ARMOR_INNATE_MODIFIERS));

    // ### Tier 3

    public static final List<AspectInstance> ZEPHYR_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.FEATHER_FALLING, 4.0f));
    ...
    public static final RegistryObject<Item> ZEPHYR_LEGGINGS = ITEMS.register("zephyr_leggings", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ZEPHYR, EquipmentSlot.LEGS, List.of(), ZEPHYR_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> ZEPHYR_BOOTS = ITEMS.register("zephyr_boots", () -> new AspectArmorItem(new Item.Properties().tab(OdysseyCreativeModeTab.ARMOR), OdysseyArmorMaterial.ZEPHYR, EquipmentSlot.FEET, List.of(), ZEPHYR_ARMOR_INNATE_MODIFIERS));
    ...
    // # Spawning
    public static final RegistryObject<Item> HUSK_SPAWN_EGG = ITEMS.register("husk_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.HUSK, 7958625, 15125652, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> MOON_TOWER_ZOMBIE_SPAWN_EGG = ITEMS.register("moon_tower_zombie_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.MOON_TOWER_ZOMBIE, 0x4C7289, 0x394140, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> SKELETON_SPAWN_EGG = ITEMS.register("skeleton_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.SKELETON, 12698049, 4802889, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> STRAY_SPAWN_EGG = ITEMS.register("stray_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.STRAY, 6387319, 14543594, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> MOON_TOWER_SKELETON_SPAWN_EGG = ITEMS.register("moon_tower_skeleton_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.MOON_TOWER_SKELETON, 0x9E9EBD, 0x565664, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> BABY_CREEPER_SPAWN_EGG = ITEMS.register("baby_creeper_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.BABY_CREEPER, 894731, 0, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> CAMO_CREEPER_SPAWN_EGG = ITEMS.register("camo_creeper_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.CAMO_CREEPER, 0x50692c, 0x79553a, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> DRIPSTONE_CREEPER_SPAWN_EGG = ITEMS.register("dripstone_creeper_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.DRIPSTONE_CREEPER, 0xBC8253, 0, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> WEAVER_SPAWN_EGG = ITEMS.register("weaver_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.WEAVER, 0x442512, 0xff4444, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> PASSIVE_WEAVER_SPAWN_EGG = ITEMS.register("passive_weaver_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.PASSIVE_WEAVER, 0x442512, 0x00b0ff, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    ...
    public static final RegistryObject<Item> BABY_LEVIATHAN_SPAWN_EGG = ITEMS.register("baby_leviathan_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.BABY_LEVIATHAN, 0x2f2f37, 0x646464, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    ...
    public static final RegistryObject<Item> ODYSSEY_POLAR_BEAR_SPAWN_EGG = ITEMS.register("polar_bear_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.POLAR_BEAR, 15921906, 9803152, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> ZOMBIE_BRUTE_SPAWN_EGG = ITEMS.register("zombie_brute_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.ZOMBIE_BRUTE, 0x6464, 7969893, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> STRAY_BRUTE_SPAWN_EGG = ITEMS.register("stray_brute_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.STRAY_BRUTE, 0x4c5c5d, 0xb1bcbc, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> BARN_SPIDER_SPAWN_EGG = ITEMS.register("barn_spider_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.BARN_SPIDER, 0x8A8A45, 11013646, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> BANDIT_SPAWN_EGG = ITEMS.register("bandit_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.BANDIT, 0x503213, 0x282828, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> WRAITH_SPAWN_EGG = ITEMS.register("wraith_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.WRAITH, 0xF3F4F5, 0xA8ACAE, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> WRAITH_STALKER_SPAWN_EGG = ITEMS.register("wraith_stalker_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.WRAITH_STALKER, 0xF3F4F5, 0xA8ACAE, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> WRAITH_AMALGAM_SPAWN_EGG = ITEMS.register("wraith_amalgam_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.WRAITH_AMALGAM, 0xF3F4F5, 0xA8ACAE, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> BLADE_SPIDER_SPAWN_EGG = ITEMS.register("blade_spider_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.BLADE_SPIDER, 0x3C3C44, 0xA80E0E, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> FORGOTTEN_SPAWN_EGG = ITEMS.register("forgotten_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.FORGOTTEN, 0x4b4c49, 0x7b8d84, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    public static final RegistryObject<Item> ENCASED_ZOMBIE_SPAWN_EGG = ITEMS.register("encased_zombie_spawn_egg", () -> new ForgeSpawnEggItem(EntityTypeRegistry.ENCASED_ZOMBIE, 0x757774, 0x927965, (new Item.Properties()).tab(OdysseyCreativeModeTab.SPAWNING)));
    ...
    public static final RegistryObject<Item> DIAMOND_SWORD = ITEMS_VANILLA.register("diamond_sword", () -> new AspectMeleeItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyTiers.DIAMOND, MeleeWeaponClass.SWORD, 8f, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_SWORD = ITEMS_VANILLA.register("netherite_sword", () -> new AspectMeleeItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyTiers.NETHERITE, MeleeWeaponClass.SWORD, 9f, List.of(), NETHERITE_INNATE_MODIFIERS));
    ...
    public static final RegistryObject<Item> DIAMOND_AXE = ITEMS_VANILLA.register("diamond_axe", () -> new AspectAxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.AXE, 7.0f, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_AXE = ITEMS_VANILLA.register("netherite_axe", () -> new AspectAxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.AXE, 8.0f, List.of(), NETHERITE_INNATE_MODIFIERS));
    ...
    public static final RegistryObject<Item> DIAMOND_PICKAXE = ITEMS_VANILLA.register("diamond_pickaxe", () -> new AspectPickaxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.PICKAXE, 6.0f, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_PICKAXE = ITEMS_VANILLA.register("netherite_pickaxe", () -> new AspectPickaxeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.PICKAXE, 7.0f, List.of(), NETHERITE_INNATE_MODIFIERS));
    ...
    public static final RegistryObject<Item> DIAMOND_SHOVEL = ITEMS_VANILLA.register("diamond_shovel", () -> new AspectShovelItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.SHOVEL, 5.5f, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_SHOVEL = ITEMS_VANILLA.register("netherite_shovel", () -> new AspectShovelItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.SHOVEL, 6.5f, List.of(), NETHERITE_INNATE_MODIFIERS));
    ...
    public static final RegistryObject<Item> DIAMOND_HOE = ITEMS_VANILLA.register("diamond_hoe", () -> new AspectHoeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.DIAMOND, MeleeWeaponClass.HOE, 5.0f, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_HOE = ITEMS_VANILLA.register("netherite_hoe", () -> new AspectHoeItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS), OdysseyTiers.NETHERITE, MeleeWeaponClass.HOE, 6.0f, List.of(), NETHERITE_INNATE_MODIFIERS));

    public static final List<AspectInstance> LEATHER_ARMOR_INNATE_MODIFIERS = List.of(new AspectInstance(Aspects.WARMTH, 0.5f));
    public static final RegistryObject<Item> LEATHER_HELMET = ITEMS_VANILLA.register("leather_helmet", () -> new DyeableAspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.LEATHER, EquipmentSlot.HEAD, List.of(), LEATHER_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> LEATHER_CHESTPLATE = ITEMS_VANILLA.register("leather_chestplate", () -> new DyeableAspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.LEATHER, EquipmentSlot.CHEST, List.of(), LEATHER_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> LEATHER_LEGGINGS = ITEMS_VANILLA.register("leather_leggings", () -> new DyeableAspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.LEATHER, EquipmentSlot.LEGS, List.of(), LEATHER_ARMOR_INNATE_MODIFIERS));
    public static final RegistryObject<Item> LEATHER_BOOTS = ITEMS_VANILLA.register("leather_boots", () -> new DyeableAspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.LEATHER, EquipmentSlot.FEET, List.of(), List.of(new AspectInstance(Aspects.WARMTH, 0.5f), new AspectInstance(Aspects.SNOWSHOE))));
    ...
    public static final RegistryObject<Item> CHAINMAIL_CHESTPLATE = ITEMS_VANILLA.register("chainmail_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.CHAIN, EquipmentSlot.CHEST, List.of(), List.of()));
    public static final RegistryObject<Item> CHAINMAIL_LEGGINGS = ITEMS_VANILLA.register("chainmail_leggings", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.CHAIN, EquipmentSlot.LEGS, List.of(), List.of()));
    public static final RegistryObject<Item> CHAINMAIL_BOOTS = ITEMS_VANILLA.register("chainmail_boots", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.CHAIN, EquipmentSlot.FEET, List.of(), List.of()));

    public static final RegistryObject<Item> IRON_HELMET = ITEMS_VANILLA.register("iron_helmet", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.IRON, EquipmentSlot.HEAD, List.of(), List.of()));
    public static final RegistryObject<Item> IRON_CHESTPLATE = ITEMS_VANILLA.register("iron_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.IRON, EquipmentSlot.CHEST, List.of(), List.of()));
    public static final RegistryObject<Item> IRON_LEGGINGS = ITEMS_VANILLA.register("iron_leggings", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.IRON, EquipmentSlot.LEGS, List.of(), List.of()));
    public static final RegistryObject<Item> IRON_BOOTS = ITEMS_VANILLA.register("iron_boots", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.IRON, EquipmentSlot.FEET, List.of(), List.of()));
    ...
    public static final List<AspectInstance> GOLDEN_ARMOR_ABILITIES = List.of(new AspectInstance(Aspects.PIGLIN_NEUTRAL));
    public static final RegistryObject<Item> GOLDEN_HELMET = ITEMS_VANILLA.register("golden_helmet", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.GOLD, EquipmentSlot.HEAD, GOLDEN_ARMOR_ABILITIES, List.of()));
    public static final RegistryObject<Item> GOLDEN_CHESTPLATE = ITEMS_VANILLA.register("golden_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.GOLD, EquipmentSlot.CHEST, GOLDEN_ARMOR_ABILITIES, List.of()));
    public static final RegistryObject<Item> GOLDEN_LEGGINGS = ITEMS_VANILLA.register("golden_leggings", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.GOLD, EquipmentSlot.LEGS, GOLDEN_ARMOR_ABILITIES, List.of()));
    public static final RegistryObject<Item> GOLDEN_BOOTS = ITEMS_VANILLA.register("golden_boots", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.GOLD, EquipmentSlot.FEET, GOLDEN_ARMOR_ABILITIES, List.of()));
    ...
    public static final RegistryObject<Item> DIAMOND_HELMET = ITEMS_VANILLA.register("diamond_helmet", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.DIAMOND, EquipmentSlot.HEAD, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> DIAMOND_CHESTPLATE = ITEMS_VANILLA.register("diamond_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.DIAMOND, EquipmentSlot.CHEST, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> DIAMOND_LEGGINGS = ITEMS_VANILLA.register("diamond_leggings", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.DIAMOND, EquipmentSlot.LEGS, List.of(), DIAMOND_INNATE_MODIFIERS));
    public static final RegistryObject<Item> DIAMOND_BOOTS = ITEMS_VANILLA.register("diamond_boots", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.DIAMOND, EquipmentSlot.FEET, List.of(), DIAMOND_INNATE_MODIFIERS));
    ...
    public static final RegistryObject<Item> NETHERITE_HELMET = ITEMS_VANILLA.register("netherite_helmet", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.NETHERITE, EquipmentSlot.HEAD, List.of(), NETHERITE_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_CHESTPLATE = ITEMS_VANILLA.register("netherite_chestplate", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.NETHERITE, EquipmentSlot.CHEST, List.of(), NETHERITE_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_LEGGINGS = ITEMS_VANILLA.register("netherite_leggings", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.NETHERITE, EquipmentSlot.LEGS, List.of(), NETHERITE_INNATE_MODIFIERS));
    public static final RegistryObject<Item> NETHERITE_BOOTS = ITEMS_VANILLA.register("netherite_boots", () -> new AspectArmorItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT), OdysseyArmorMaterial.NETHERITE, EquipmentSlot.FEET, List.of(), NETHERITE_INNATE_MODIFIERS));
