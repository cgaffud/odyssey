...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> CHICKEN_HELMET = ITEMS.register("chicken_helmet", () -> new ChickenArmorItem(OdysseyArmorMaterial.CHICKEN, EquipmentSlotType.HEAD, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> CHICKEN_CHESTPLATE = ITEMS.register("chicken_chestplate", () -> new ChickenArmorItem(OdysseyArmorMaterial.CHICKEN, EquipmentSlotType.CHEST, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> CHICKEN_LEGGINGS = ITEMS.register("chicken_leggings", () -> new ChickenArmorItem(OdysseyArmorMaterial.CHICKEN, EquipmentSlotType.LEGS, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> CHICKEN_BOOTS = ITEMS.register("chicken_boots", () -> new ChickenArmorItem(OdysseyArmorMaterial.CHICKEN, EquipmentSlotType.FEET, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    ...
    public static final RegistryObject<Item> TURTLE_CHESTPLATE = ITEMS.register("turtle_chestplate", () -> new UpperTurtleArmorItem(OdysseyArmorMaterial.TURTLE, EquipmentSlotType.CHEST, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> TURTLE_LEGGINGS = ITEMS.register("turtle_leggings", () -> new LowerTurtleArmorItem(OdysseyArmorMaterial.TURTLE, EquipmentSlotType.LEGS, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> TURTLE_BOOTS = ITEMS.register("turtle_boots", () -> new LowerTurtleArmorItem(OdysseyArmorMaterial.TURTLE, EquipmentSlotType.FEET, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    ...
    public static final RegistryObject<Item> REINFORCED_HELMET = ITEMS.register("reinforced_helmet", () -> new ReinforcedArmorItem(OdysseyArmorMaterial.REINFORCED, EquipmentSlotType.HEAD, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> REINFORCED_CHESTPLATE = ITEMS.register("reinforced_chestplate", () -> new ReinforcedArmorItem(OdysseyArmorMaterial.REINFORCED, EquipmentSlotType.CHEST, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> REINFORCED_LEGGINGS = ITEMS.register("reinforced_leggings", () -> new ReinforcedArmorItem(OdysseyArmorMaterial.REINFORCED, EquipmentSlotType.LEGS, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> REINFORCED_BOOTS = ITEMS.register("reinforced_boots", () -> new ReinforcedArmorItem(OdysseyArmorMaterial.REINFORCED, EquipmentSlotType.FEET, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    ...
    public static final RegistryObject<Item> ARCTIC_HELMET = ITEMS.register("arctic_helmet", () -> new ArcticArmorItem(OdysseyArmorMaterial.ARCTIC, EquipmentSlotType.HEAD, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> ARCTIC_CHESTPLATE = ITEMS.register("arctic_chestplate", () -> new ArcticArmorItem(OdysseyArmorMaterial.ARCTIC, EquipmentSlotType.CHEST, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> ARCTIC_LEGGINGS = ITEMS.register("arctic_leggings", () -> new ArcticArmorItem(OdysseyArmorMaterial.ARCTIC, EquipmentSlotType.LEGS, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> ARCTIC_BOOTS = ITEMS.register("arctic_boots", () -> new ArcticArmorItem(OdysseyArmorMaterial.ARCTIC, EquipmentSlotType.FEET, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    ...
    public static final RegistryObject<Item> ZEPHYR_HELMET = ITEMS.register("zephyr_helmet", () -> new ZephyrArmorItem(OdysseyArmorMaterial.ZEPHYR, EquipmentSlotType.HEAD, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> ZEPHYR_CHESTPLATE = ITEMS.register("zephyr_chestplate", () -> new ZephyrArmorItem(OdysseyArmorMaterial.ZEPHYR, EquipmentSlotType.CHEST, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> ZEPHYR_LEGGINGS = ITEMS.register("zephyr_leggings", () -> new ZephyrArmorItem(OdysseyArmorMaterial.ZEPHYR, EquipmentSlotType.LEGS, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> ZEPHYR_BOOTS = ITEMS.register("zephyr_boots", () -> new ZephyrArmorItem(OdysseyArmorMaterial.ZEPHYR, EquipmentSlotType.FEET, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));

    public static final RegistryObject<Item> LEVIATHAN_HELMET = ITEMS.register("leviathan_helmet", () -> new UpperLeviathanArmorItem(OdysseyArmorMaterial.LEVIATHAN, EquipmentSlotType.HEAD, new Item.Properties().fireResistant().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> LEVIATHAN_CHESTPLATE = ITEMS.register("leviathan_chestplate", () -> new UpperLeviathanArmorItem(OdysseyArmorMaterial.LEVIATHAN, EquipmentSlotType.CHEST, new Item.Properties().fireResistant().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> LEVIATHAN_LEGGINGS = ITEMS.register("leviathan_leggings", () -> new LowerLeviathanArmorItem(OdysseyArmorMaterial.LEVIATHAN, EquipmentSlotType.LEGS, new Item.Properties().fireResistant().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> LEVIATHAN_BOOTS = ITEMS.register("leviathan_boots", () -> new LowerLeviathanArmorItem(OdysseyArmorMaterial.LEVIATHAN, EquipmentSlotType.FEET, new Item.Properties().fireResistant().tab(OdysseyItemGroup.COMBAT)));
    ...
    //Bats
    public static final RegistryObject<Item> GRANITE_BAT = ITEMS.register("granite_bat", () -> new BatItem(OdysseyItemTier.GRANITE, 5, -2.7f, 1, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> COPPER_BAT = ITEMS.register("copper_bat", () -> new BatItem(OdysseyItemTier.COPPER, 6, -2.7f, 2, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> OBSIDIAN_BAT = ITEMS.register("obsidian_bat", () -> new BatItem(OdysseyItemTier.OBSIDIAN, 8, -2.7f, 3, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));

    //Hammers
    public static final RegistryObject<Item> GRANITE_HAMMER = ITEMS.register("granite_hammer", () -> new HammerItem(OdysseyItemTier.GRANITE, 7, -3.2f, 1, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> COPPER_HAMMER = ITEMS.register("copper_hammer", () -> new HammerItem(OdysseyItemTier.COPPER, 8, -3.2f, 2, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    public static final RegistryObject<Item> OBSIDIAN_HAMMER = ITEMS.register("obsidian_hammer", () -> new HammerItem(OdysseyItemTier.OBSIDIAN, 10, -3.2f, 3, new Item.Properties().tab(OdysseyItemGroup.COMBAT)));
    ...
    public static final RegistryObject<Item> MARINE_AXE = ITEMS.register("marine_axe", () -> new MarineAxeItem(OdysseyItemTier.MARINE, 8.0f, -2.5f, new Item.Properties().tab(OdysseyItemGroup.TOOLS)));
    ...
    public static final RegistryObject<Item> MARINE_PICKAXE = ITEMS.register("marine_pickaxe", () -> new MarinePickaxeItem(OdysseyItemTier.MARINE, 4, -2.2f, new Item.Properties().tab(OdysseyItemGroup.TOOLS)));
    ...
    public static final RegistryObject<Item> MARINE_SHOVEL = ITEMS.register("marine_shovel", () -> new MarineShovelItem(OdysseyItemTier.MARINE, 3.5f, -1.9f, new Item.Properties().tab(OdysseyItemGroup.TOOLS)));
    ...
    public static final RegistryObject<Item> MARINE_Hoe = ITEMS.register("marine_hoe", () -> new MarineHoeItem(OdysseyItemTier.MARINE, 3, -1.0f, new Item.Properties().tab(OdysseyItemGroup.TOOLS)));
