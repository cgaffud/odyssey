...
public class ContainerRegistry {
    ...
    public static final RegistryObject<MenuType<ResearchTableMenu>> RESEARCH_TABLE = CONTAINER.register("research_table", () -> new MenuType<ResearchTableMenu>(ResearchTableMenu::new));
